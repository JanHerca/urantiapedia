...
Aquí se incluyen diferentes índices. Si el número de elementos que se obtiene en el índice es muy alto se puede planear hacer una página principal donde estarían las divisiones principales, y luego hacer páginas secundarias. Siempre que sea posible es preferible que cada índice sea sólo una página, para que sea más fácil ubicar algo. 
...
* Índice de Referencias. Para cada documento de *El Libro de Urantia*, todas las referencias en otros libros, ya sea la Bilbia u otros. Ordenado por orden de lectura en el libro.
