...
Tento web je dostupný pod licencí [Creative Commons Attribution-ShareAlike License 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.cs), pokud není uvedeno upozornění na autorská práva, jak je vysvětleno v části _Omezení_ na této stránce.

Krátký identifikátor licence: **CC-BY-SA-4.0**
...
Toto je lidským čitelným shrnutím (a nikoli náhradou) [licence](/cs/help/full_license).

<p style="text-align:center;"><b>Dílo smíte:</b></p>
...
<p style="text-align:center;"><b>Za těchto podmínek</b></p>
...
<p style="text-align:center;"><b>Poznámky:</b></p>
...
Některý obsah na této webové stránce je reprodukován se svolením různých držitelů autorských práv nebo je ve veřejné doméně. Na tento obsah se nevztahuje obecná licence **CC-BY-SA-4.0** webu.
...
- Články z [Fellowship Journal](/en/index/articles_spiritual_fellowship_journal) (ve všech jazycích) jsou chráněny autorským právem každého autora a [The Urantia Book Fellowship](https://urantiabook.org/).
...
- Články z [zpravodaje „Luz y Vida“](/es/index/articles_luz_y_vida) jsou chráněny autorským právem každého autora a [Urantia Spanish Association](https://aue.urantia-association.org/).
...
Toto je pro člověka čitelný souhrn podmínek použití. Úplné znění podmínek si můžete přečíst zde: [Podmínky použití](/cs/help/terms_of_use).
