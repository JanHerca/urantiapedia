...
Meie sisu Meie sisu on mõeldud ainult vaimse valgustuse eesmärgil: me ei majuta üldse teavet, mis puudutab erialaseid teemasid, sealhulgas meditsiinilisi, juriidilisi või finantsküsimusi. Ühtegi sisu ei tohiks võtta kui professionaalset nõuannet. 

## 4. Teatud tegevustest hoidumine


Teatud tegevused, olgu need siis seaduslikud või ebaseaduslikud, võivad kahjustada teisi kasutajaid ja rikkuda meie reegleid ning mõned tegevused võivad ka teid vastutusele võtta. Seetõttu ei tohi te enda ja teiste kasutajate kaitseks meie saidil selliseid tegevusi teha. Nende tegevuste hulka kuuluvad: 

- **Teiste ahistamine ja kuritarvitamine** - Ahelpostituse 
	, rämpsposti või rämpsposti edastamine teistele kasutajatele. 
- **Teiste privaatsuse rikkumine** 
	- teiste isikute privaatsusõiguste rikkumine vastavalt Hispaania seadustele või muudele kohaldatavatele seadustele (mis võivad hõlmata teie elukoha või sisu vaatamise või muutmise seadusi);
	...
	– isikut tuvastava teabe küsimine kõigilt alla 18-aastastelt ebaseaduslikul eesmärgil või mis tahes kohaldatavate alaealiste tervise või heaoluga seotud seaduste rikkumisega. 
- **Valeavaldustega, kellegi teisena esinemise või pettusega tegelemine** 
...
- **Meie teenuste kuritarvitamine muudel ebaseaduslikel eesmärkidel** 
	- lapsporno või muu sisu postitamine, mis rikub kohaldatavat lapspornot käsitlevat seadust; 
	- Kohaldatava õiguse kohaselt ebaseadusliku nilbe materjali postitamine või sellega kaubitsemine; ja 
	– teenuste kasutamine viisil, mis ei ole kooskõlas kohaldatava õigusega. 
- **Rajatiste häiriva ja ebaseadusliku väärkasutusega tegelemine** 
	...
	- teenuste katkestamine, ujutades Urantiapedia üle side või muu liiklusega, mis viitab sellele, et puudub tõsine kavatsus veebisaiti ettenähtud eesmärgil kasutada; 
	- mis tahes meie tehniliste süsteemide või võrkude haavatavuse uurimine, skaneerimine või testimine, välja arvatud juhul, kui on täidetud kõik järgmised tingimused: 
		- sellised toimingud ei kuritarvita ega häiri meie tehnilisi süsteeme või võrke liigselt; 
...
## 5. Registreerimine ja 

parooliturve _Urantia raamatu_ lugejad, kes soovivad olla Urantiapedia kaastöötajad, peavad süsteemiadministraatorid mõne sidevahendi (nt e-posti või vestluse) kaudu usaldusväärseks kinnitama. Urantiapedia administraatoritega ühenduse võtmiseks võite kasutada mõnda järgmistest toimingutest: 
- Saada meiliaadressile urantiapedia@gmail.com
...
- g. **Taaskasutamine**: meie hostitud sisu taaskasutamine on teretulnud, kuigi „ausa kasutamise” või sarnaste autoriõiguse seaduse erandite alusel edastatud sisu puhul on erandeid. Igasugune taaskasutamine peab vastama aluseks oleva(te) litsentsi(de)le. Kui kasutate või levitate uuesti Urantiapedia kogukonna väljatöötatud tekstilehte, nõustute omistama autorid ühel järgmistest viisidest: 
	- Hüperlingi (võimaluse korral) või URL-i kaudu lehele või lehtedele, mida te uuesti kasutate. kasutades (kuna igal lehel on ajalooleht, kus on loetletud kõik autorid ja toimetajad);
...
Urantiapedia kaastööliste kogukonnal on tema suhtes kohaldatavate poliitikate loomisel ja jõustamisel peamine roll. Ebatavalisel juhul võime pöörduda eriti probleemse kaastöölise kasutaja poole, kuna see on häiritud või ohtlik. Sellistel juhtudel jätame endale õiguse, kuid meil ei ole kohustust: 
- uurida kaastöötajate teenust (a) teha kindlaks, kas on toimunud käesolevate kasutustingimuste või muu kohaldatava seaduse või poliitika rikkumine või (b) järgima mis tahes kohaldatavat seadust, õigusprotsessi või asjakohast valitsuse taotlust; 
...
- hallata Urantiapediat muul viisil viisil, mis on kavandatud hõlbustama selle nõuetekohast toimimist ning kaitsma meie ja meie kasutajate, litsentsiandjate, partnerite ja avalikkuse õigusi, vara ja turvalisust. 
...
Konto või juurdepääsu blokeerimine või kasutaja blokeerimine käesoleva sätte alusel toimub vastavalt käesolevate kasutustingimuste punktile 12.

## 11. Urantiapedia eeskirjad 

Urantiapedia juhatus võib aeg-ajalt avaldada uusi ametlikke eeskirju. Nõustute neid vastavalt vajadusele järgima. 
...
## 13. Vaidlused ja jurisdiktsioon 
...
Mõned riigid või jurisdiktsioonid ei luba selles jaotises esitatud vastutusest loobumise tüüpe, mistõttu need ei pruugi teie kohta olenevalt seadusest kehtida osaliselt ega täielikult. 
...
Need kasutustingimused on kirjutatud inglise keeles (USA). Kuigi loodame, et nende kasutustingimuste tõlked on täpsed, on ingliskeelse originaalversiooni ja tõlke tähenduste erinevuste korral ülimuslik ingliskeelne originaalversioon.
...
Tagasi lehele, kus on kokkuvõte [litsents, kasutustingimused ja muu juriidiline teave](/et/license).