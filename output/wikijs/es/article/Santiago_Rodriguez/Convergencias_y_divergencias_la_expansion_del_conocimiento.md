    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Luis_Coll/La_majestad_de_poder_elegir_el_Libre_Albedrio">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">La majestad de poder elegir: el libre albedrío</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Luz_y_Vida/Cuestionario_Urantiano_Miguel_Bustos">
          <span class="pr-2">Cuestionario urantiano: Miguel Bustos</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
