    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Steve_Dreier/Presidents_Report_to_the_General_Council">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Informe del Presidente al Consejo General</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Study_Group_Herald/Calendar_4">
          <span class="pr-2">Calendario de eventos</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
