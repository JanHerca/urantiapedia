    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/David_Linthicum/dissemination_committee_update">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Novedades del comité de Diseminación</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Gaetan_Charland/more_on_study_groups">
          <span class="pr-2">Más sobre grupos de estudio</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
