    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Merlyn_Cox/A_Celebration_of_Low_Technology">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Interfaz: una celebración de la baja tecnología</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Spiritual_Fellowship_Journal/Our_Subliminal_Mentor">
          <span class="pr-2">Nuestro mentor subliminal</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
