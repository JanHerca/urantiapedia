---
title: "Ordenación en Boulder... Un día para recordar"
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Larry_Mullins/The_Greatest_Thing_Richard_Feynman_Bver_Wrote">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Lo más grande que jamás haya escrito Richard Feynman</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Larry_Mullins/Great_Urantians_Lest_We_Forget_Peggy_Johnson">
          <span class="pr-2">Grandes Urantianos. Para que no lo olvidemos - Peggy Johnson</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
