    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Ken_Glasziou/James_the_Brother_of_Jesus_What_happened_to_him">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Santiago, el hermano de Jesús. ¿Qué le pasó?</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Jacques_Tetrault/Relating">
          <span class="pr-2">¡Relacionarse!</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
