    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Meredith_Sprunger/New_Dimensions_in_Theology">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Nuevas dimensiones de la teología</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Merlyn_Cox/Arguing_With_Nicodemus">
          <span class="pr-2">Interfaz: Discutiendo con Nicodemo</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
