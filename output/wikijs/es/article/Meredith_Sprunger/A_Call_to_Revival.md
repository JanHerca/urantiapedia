    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Meredith_Sprunger/Confirming_and_Enlarging_the_Biblical_Message">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Confirmando y ampliando el mensaje bíblico</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Merlyn_Cox/When_Time_is_Not_of_Essence">
          <span class="pr-2">Interfaz: Cuando el tiempo no es esencial</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
