...
1. Abra el libro al mismo tiempo para
	...
	- b) estudiar
		...
		- de todos modos
2. Orar al mismo tiempo (aunque sea unos minutos)
3. Establecer un calendario de fiestas (al menos Nacimiento, Bautismo y Crucifixión)
4. Generalizar la comida del recuerdo
	- a) copia fiel del original
	- b) forma libre
5. Encuentre un lugar “especialmente práctico” (ver 1840-5)
