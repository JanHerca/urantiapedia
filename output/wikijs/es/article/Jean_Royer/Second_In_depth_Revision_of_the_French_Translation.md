---
title: "Segunda revisión en profundidad de la traducción al francés"
description: 
published: true
...
<p class="v-card v-sheet theme--light gray lighten-3 px-2">© 2014 Jean Royer<br>© 2014 Fundación Urantia</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Wilson_Leon/The_International_Book_Fair_in_Bogota_Colombia">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">La Feria Internacional del Libro de Bogotá (Colombia)</span>
        </a>
        </td>
        <td>
        <a href="/es/index/articles_uf_news_online#volume-8-issue-2-july-2014">
          <span class="mdi mdi-book-open-variant"></span><span class="pl-2">Volumen 8, Número 2, Julio 2014 — Índice</span>
        </a>
        </td>
        <td>
        <a href="/es/article/Scott_Brooks/The_Urantia_Book_Study_Group_Directory">
...
> Esperamos que esta última revisión de la traducción francesa aumente la conciencia cósmica y eleve la percepción espiritual
