...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Francois_Audet/Reflexions_sur_notre_futur_morontiel">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Reflexiones sobre nuestro futuro morontial</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Jean_Lapierre/La_perfection_dintention">
          <span class="pr-2">¡Perfección de intención!</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
Durante un momento de remordimiento, descubrió el maravilloso _Libro de Urantia_ en la biblioteca de la prisión.
