    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Peter_Laurence/Editors_Note">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Nota del editor</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Helena_E_Sprague/Revelation_and_receptivity">
          <span class="pr-2">Revelación y receptividad</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
