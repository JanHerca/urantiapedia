    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Neil_Francey/On_the_Revelatory_Status/Timeline_of_Events_After_Publication">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Cronología de eventos después de la publicación</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Neil_Francey/On_the_Revelatory_Status/Could_The_Fifth_Revelation_Default">
          <span class="pr-2">¿Podría la Quinta Revelación fallar?</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
## ¿Quién escribió _El libro de Urantia_?
...
Una búsqueda sobre «quién escribió _El libro de Urantia_» arroja buenos resultados. Como era de esperar, existen unos pocos detractores y sus propuestas carecen de sustancia.
...
En la publicación [Ciencia, antropología y arqueología en El Libro de Urantia](/es/book/Ken_Glasziou/Science_Anthropology_and_Archaeology_in_The_Urantia_Book), Ken Glasziou hizo un análisis de los estilos de escritura de varios artículos bajo estos títulos:
- Metodología para la determinación de la autoría
- ¿Era el Dr. Sadler un autor?
- ¿Podría una sola mente humana ser la fuente de los Documentos?
...
## Cómo no conseguimos _El Libro de Urantia_
...
## ¿Utilizaron los reveladores fuentes escritas por humanos?
...
Hay un artículo sobre este tema disponible en: [Selecciones de escritos que se cree que son «Fuentes» del Libro de Urantia](/es/article/Selections_from_Writings_Thought_to_be_UB_Sources). También muestra formas en las que se han utilizado los recursos humanos en la construcción del texto.
...
## ¿Fue escrito por un comité de personas?

Sí, los Documentos de _El Libro de Urantia_ fueron asignados, escritos y compilados por un comité de varios autores celestiales. El título, o quizás la descripción de la función, de cada una de estas personalidades celestiales, se indica en el índice y al final de cada documento.
...
Pero una vez más, un formato así para la producción humana no tiene comparación con _El Libro de Urantia_.

## ¿Existe una técnica de enseñanza reveladora específica?
