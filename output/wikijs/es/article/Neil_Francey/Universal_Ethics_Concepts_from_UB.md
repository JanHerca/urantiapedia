---
title: "Ética universal: conceptos del libro de Urantia"
description: 
published: true
...
Este proceso evolutivo de revelación no es nuevo. De hecho, es la misma forma en que hemos progresado hasta nuestro estado actual.

Estos módulos se pueden utilizar en un entorno grupal facilitado por un maestro o como un estudio personal a su propio ritmo. Están diseñados para usarse junto con el texto completo de _El Libro de Urantia_.

Para ver el trabajo completo haga clic en: [Ética Universal](/es/article/Neil_Francey/Universal_Ethics)

**_Nota del editor_**_: Esta es otra gran ayuda para el estudio de Neil Francey, quien nos ha brindado «SuperMeditación» y «Negocios en Urantia» en los últimos años. Puedes encontrar más de sus trabajos en el sitio web en:_
