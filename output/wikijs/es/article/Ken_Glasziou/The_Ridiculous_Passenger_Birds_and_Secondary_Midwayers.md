---
title: "Algo absurdo: pájaros transportadores e intermedios secundarios"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Ken_Glasziou/Prove_it_to_yourself_for_yourself">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">«Pruébalo por ti mismo»</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Ken_Glasziou/Miscellaneous_erroneous_material_summarized">
          <span class="pr-2">Miscelánea de material erróneo: un resumen</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
En caso de que la historia de la tierra y la luna no fuera suficiente para poner a prueba nuestra credulidad, los autores del Libro han progresado desde lo absurdo hasta lo absolutamente ridículo al presentarnos a las aves pasajeras ya los intermedios secundarios.
