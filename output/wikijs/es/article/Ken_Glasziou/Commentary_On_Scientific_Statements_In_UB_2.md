---
título: "Comentario sobre las declaraciones científicas del Libro de Urantia, Parte II"
description: 
published: true
...
(_El Libro de Urantia_ divide las atmósferas en 4 categorías: ninguna, baja, media y alta densidad. Una suposición aleatoria sobre una atmósfera planetaria tendría una probabilidad entre cuatro de ser correcta. Para ser correcto para dos planetas, las posibilidades de ser correcto para ambos son uno de cada dieciséis.)
...
>
> En 1935, el astrofísico indio Subrahmanyan Chandrasekhar demostró que una estrella que es al menos un 40% más masiva que el Sol, después de agotar sus fuentes de energía, termina colapsando en una esfera de materia extremadamente densa que explota violentamente.
>
> La teoría actual sostiene que una clase de novas, denominada Tipo I, son en realidad explosiones que ocurren en sistemas estelares dobles. Un miembro de este sistema estelar doble es una estrella enana blanca vieja, energéticamente agotada y muy densa. Si la enana blanca orbita cerca de una estrella compañera, su intensa gravedad extraerá materia de la superficie de la segunda estrella. Con el tiempo, la masa de la estrella enana crecerá más allá
>
> El límite de Chandrasekhar, lo que provoca una violenta explosión que perturba ambas estrellas. Otra clase de novas, denominada Tipo II, no surge de estrellas dobles, sino que ocurre como eventos naturales en la evolución de estrellas individuales masivas.
>
> En 1952, los restos de la nova de Tycho fueron descubiertos con el radiotelescopio de 250 pies de Jodrell Bank. En los años transcurridos desde su descubrimiento, el remanente de Tycho ha sido mapeado extensamente por radiotelescopios y, más recientemente, por el Observatorio de rayos X en órbita Einstein. Estas observaciones muestran que los restos de Tycho resultaron de la explosión de una estrella doble, como se afirma en el _Libro de Urantia_. (fin de la cita)
...
Las diminutas partículas privadas de potencial eléctrico a las que se hace referencia en el _Libro de Urantia_ corresponden a lo que ahora se llaman neutrinos. No se demostró la existencia de estas diminutas partículas hasta 1956, un año después de la primera publicación del _Libro de Urantia_. (Consulte la sección sobre física subatómica para obtener más comentarios sobre el neutrino).
