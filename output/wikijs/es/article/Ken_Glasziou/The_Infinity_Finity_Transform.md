    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Ken_Glasziou/Editorial_Windows_of_Opportunity">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Ventanas de Oportunidad</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/William_Trimble/On_Completion">
          <span class="pr-2">Al finalizar</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
El detalle de este proceso, tal como se describe en los Documentos de Urantia, se presenta en forma de diagrama abreviado en [La transmutación de las potencialidades y realidades existenciales al nivel finito de realidad](/es/article/The_Transmutation_of_Existential).
...
Ahora que el campo de la teología del proceso se ha vueltoentre un grupo de personas con mentalidad académica, puede suceder que se presenten oportunidades a los lectores del _Libro de Urantia_ para llamar su atención sobre los paralelismos en los Documentos. Nuestra tarea es sembrar semillas para que otros puedan cosechar.
