    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Ann_Bendall/Better_Communication_with_My_Thought_Adjuster">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Mejor comunicación con mi ajustador del pensamiento</span>
        </a>
        </td>
        <td>
...
El párrafo 2 comenta, **"las alternancias del estado de energía son increíblemente rápidas..."** Según el ganador del premio Nobel, Steven Weinberg, ocurren en el orden de un millón, millón, millón, millonésima de segundo. Por el contrario, el proceso descrito en el párrafo 3 dura aproximadamente una centésima de segundo.
