...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2017 Alice Wood<br>© 2017 Asociación Urantia Internacional (IUA)</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Gaetan_Charland/study_groups_and_us_survey_results">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Los grupos de estudio y nosotros: resultados de la encuesta</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Cheryl_Glicker/young_readers_study_groups">
          <span class="pr-2">Lectores jóvenes y grupos de estudio</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
