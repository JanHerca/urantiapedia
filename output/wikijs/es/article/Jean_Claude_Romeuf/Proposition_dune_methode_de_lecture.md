---
title: "Propuesta de método de lectura"
description: 
published: true
...
- el Cociente de Inteligencia es la medida de referencia de la inteligencia. Me pregunto si es deseable una aproximación al libro, basada únicamente en la razón, en el análisis lógico, en el aprendizaje de conocimientos a través de la memoria, en grupo. ¡Rápidamente nos damos cuenta de que en lugar de encontrar a Dios, encontramos la Nada! Es una lucha despiadada entre miembros divididos. Asistimos entonces a una lucha real cuyo objetivo individual es imponer “la propia verdad”. Es una batalla de cerebro contra cerebro.
- el Cociente Emocional. ¡No quiero hablar aquí de emociones infantiles que es necesario erradicar de nosotros, porque autorizan los peores excesos que son la búsqueda del milagro, el aspecto sobrenatural de los fenómenos ordinarios y, en definitiva, no son más que otra forma disfrazada de búsqueda del poder! Hay que dejar un poco de espacio a la sensibilidad, verdadera fuente de inspiración y creatividad. LU puede volvernos sensibles; es una musa inspiradora de belleza y verdad. Exalta el arte y la filosofía.
- el Cociente Espiritual. Si bien corre el riesgo de hacernos caer en una mística exacerbada con todos los peligros que ello implica, el cociente espiritual está también en el origen del culto al Espíritu.
