    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Gaetan_Charland/study_groups_revisited">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Revisión de los grupos de estudio</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Moustapha_NDiaye/dynamic_and_living_peace">
          <span class="pr-2">Paz dinámica y viva</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
