    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/David_Elders/La_Verite_personnelLement_decouverte">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Verdad personal descubierta</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Georges_Michelson_Dupont/L_enfant_Jesus_et_les_docteurs_de_la_Loi">
          <span class="pr-2">El niño Jesús y los doctores de la Ley</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
<figcaption>La Isla del Paraíso y los 3 circuitos del Padre, el Hijo</figcaption>
</figure>
...
<figcaption>El universo central de Havona</figcaption>
</figure>
...
<figcaption>El gran universo</figcaption>
</figure>
...
1. la capacidad de saberlo,
2. la búsqueda del Padre Universal
3. el deseo sincero de hacer su voluntad.
...
1. materialismo, el hombre deja de existir como personalidad, ya que pierde su cuerpo al morir.
2. En el panteísmo Dios no es una persona ya que no tiene cuerpo.
