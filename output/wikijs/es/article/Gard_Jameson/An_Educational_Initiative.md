...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2007 Gard Jameson<br>© 2007 Fundación Urantia</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Irmeli_Sjolie/Portuguese_Translation">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">La Fundación imprime una traducción al portugués</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Tamara_Wood/Distribution_El_Libro_De_Urantia">
          <span class="pr-2">Distribución: El Libro De Urantia</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
