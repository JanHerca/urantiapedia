    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Gaetan_Charland/experiment_online_study_group">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Experimento en el grupo de estudio</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Mairam_Durand/book_fair_lima_peru">
          <span class="pr-2">Feria del Libro de Lima (Perú)</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
