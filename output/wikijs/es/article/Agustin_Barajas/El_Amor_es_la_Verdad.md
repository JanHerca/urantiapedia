    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Luis_Coll/Las_Verdades_Relativas">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Las verdades relativas</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Santiago_Rodriguez/Convergencias_y_divergencias_El_Entrelazamiento_Cuantico">
          <span class="pr-2">Convergencias y divergencias: El entrelazamiento cuántico</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
