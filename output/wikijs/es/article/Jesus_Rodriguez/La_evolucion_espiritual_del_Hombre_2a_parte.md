...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Olga_Lopez/Luz_y_Vida_Num_30_Presentacion">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Luz y Vida — Núm. 30 — Presentación</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Luis_Coll/El_Libro_de_Urantia_y_la_reencarnacion">
          <span class="pr-2">El Libro de Urantia y la reencarnación</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
