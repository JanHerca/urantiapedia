    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Anne_Muriel_Brouet/Le_boson_de_Higgs">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">El bosón de Higgs</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Max_Masotti/Quiz_maxien_08_Les_reponses">
          <span class="pr-2">Maxien Quiz n°8 Las respuestas</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
