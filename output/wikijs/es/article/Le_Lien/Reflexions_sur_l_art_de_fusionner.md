---
title: "Reflexiones sobre el arte de fusionar"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Max_Masotti/Quiz_maxien_21_Les_questions">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">MAXIEN Quiz n²21 y último — Preguntas</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Max_Masotti/Quiz_maxien_21_Les_reponses">
          <span class="pr-2">Prueba n.º 21: Respuestas</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
Tengamos presente que nuestra meta es llegar a ser espíritu puro. Todo espíritu tiene una mente. Pero no podemos llegar allí sin pasar por la etapa morontial, y esta etapa morontial es el alma.

Si miramos de cerca todo lo que concierne al alma, percibimos que no es algo así como una burbuja externa que se desarrolla independientemente de sí misma, sino una parte de nosotros que crece gradualmente y reemplaza gradualmente nuestro plan operativo.

Déjame explicarte:

nuestra mente trabaja cada vez más al nivel de nuestros valores y cada vez menos al nivel automático de los espíritus mentales ayudantes y esto inconscientemente bajo los impulsos del Ajustador y otras influencias de personalidades superiores pero hablaremos de eso nuevamente.

Es el cruce de círculos psíquicos.
...
Ante todo, esta espiritualización es un acto consciente y voluntario de la personalidad. La búsqueda de valores y la comprensión del universo requieren una actividad constante de investigación a través de la experiencia y el estudio.
...
Asimismo, un factor esencial parece ser la rectitud que se caracteriza por la coherencia en la aplicación de los valores percibidos en todas las circunstancias con el máximo discernimiento (verdad, belleza, bondad).

Nuestra vida morontial comienza aquí en la tierra, dejando que nuestra alma hable, y la grandeza del alma no es un adjetivo vacío.

Lo dejo ahí para que os sumerjáis en este viaje y os animo a recorrer la vida de Jesús antes de su bautismo para descubrir qué experiencias atravesó hasta llegar al estado de fusión.
