---
title: "Oración y adoración como debemos entenderla"
description: 
published: true
...
> - una declaración de la lealtad del alma, 
> - una recitación de devoción personal, 
> - una expresión de acción de gracias, 
> - una manera de evitar la tensión emocional, 
> - una prevención de los conflictos, 
> - una exaltación del intelecto, 
> - un ennoblecimiento de los deseos, 
> - una confirmación de las decisiones morales, 
> - un enriquecimiento del pensamiento, 
> - una estimulación de las tendencias más elevadas, 
> - una consagración del impulso, 
> - una clarificación de un punto de vista, 
> - una declaración de fe, 
> - una rendición trascendental de la voluntad, 
> - una sublime afirmación de confianza, 
> - una revelación de valentía, 
> - la proclamación de un descubrimiento, 
...
- Cuida nuestros detalles. (No existe ningún problema excepto que alguien dejó un detalle sin hacer).
- Recuerda que causa y efecto son las leyes naturales del universo. (Aquí todo es de naturaleza dual y la dualidad es la separación de la causa del efecto a modo de función).
- Tomar nuestras decisiones siempre «por el mayor bien de todos los interesados».
	- Localizar la dificultad,
	- Aislar el problema,
	- Eliminar las personalidades,
	- Eliminar prejuicios, pasiones y todos los demás prejuicios,
	- Reconocer su naturaleza y gravedad,
	- Utilice tacto y tolerancia,
	- Y haz lo que sea por el mayor bien para todos los involucrados, no solo para ti. (Considere a todos los demás: usted será atendido).
- Déjate llevar y deja que Dios se encargue del resto con confianza en
- Desarrollar la paciencia, la tolerancia y la compasión: estos son los componentes principales del amor.
- Quitar el miedo y la inseguridad.
- Convertir los impulsos (en el arte social de vivir), transferir los señuelos (deben transferirse al atractivo de la cosmología universal) y transformar los deseos (en anhelos espirituales que sean capaces de alcanzarse de forma permanente).

Lo que sucede es que a medida que cambiamos diariamente nuestros patrones de hábitos, usando la ley de Dios para tomar decisiones para hacer el «bien mayor para todos los involucrados», adquirimos verdadera sabiduría, utilizamos la fe, generamos confianza a partir de esa fe y finalmente comenzamos a confiar. La capacidad de Dios para trabajar por nosotros y con nosotros.

La confianza surge y se construye a medida que decidimos repetidamente hacer el «bien mayor para todos los involucrados» y literalmente vemos los resultados sin ninguna ayuda nuestra, excepto la intención de hacer el bien mayor. Descubriremos eso y demostraremos que nuestro Padre es el Ser más perfectamente consistente que jamás hayamos encontrado y entonces será fácil confiar en Él cuando los resultados sean evidentes.

## Condiciones de la oración efectiva

«Si deseas orar eficazmente, debes tener en cuenta las leyes de las peticiones prevalecientes:»
1. Debes calificar como una oración potente al enfrentar con sinceridad y valentía los problemas de la realidad universal. Debes poseer resistencia cósmica. (No viva en un mundo de sueños; sea realista acerca de la situación y tome medidas para resolverla usted mismo primero y haga un esfuerzo adicional para intentar hacerlo).
2. Honestamente debes haber agotado la capacidad humana de adaptación humana. Debes haber sido trabajador. (En caso de enfermedad, debemos haber agotado toda la ayuda médica disponible; en caso de negocios, debemos haber hecho todo lo posible para salvar la situación).
3. Debes entregar cada deseo de la mente y cada anhelo del alma al abrazo transformador del crecimiento espiritual. (Debemos trabajar cada día para modificar lo negativo de nuestras vidas y tomar decisiones para un bien mayor.) Debes haber experimentado una mejora de significados y una elevación de valores. (A medida que desarrolles la espiritualidad, la vida cambiará en tu sentido de los valores y el significado de estos).
...
Se nos dice que la oración genuina:
- Contribuye al crecimiento espiritual,
- Modifica actitudes, y
- Produce esa satisfacción que proviene de la comunión con la divinidad.
- ¡Es un estallido espontáneo de conciencia de Dios!

Nuevamente se nos dice que Dios contesta la oración del hombre:
- Al darle una mayor revelación de la verdad,
- Una mayor apreciación de la belleza, y
- Un concepto aumentado de bondad,
- La oración es un gesto subjetivo,
- Pero contacta con poderosas realidades objetivas en los niveles espirituales de la experiencia humana,
- Es un alcance significativo por parte del ser humano hacia valores sobrehumanos y
- ¡Es el estímulo de crecimiento espiritual más potente!

_Y la adoración es agradecimiento por todo lo que tenemos, sabemos y somos._
