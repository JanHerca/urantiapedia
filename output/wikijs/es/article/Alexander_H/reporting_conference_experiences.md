    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Mark_Kurtz/considerations_for_study_of_the_human_jesus">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Consideraciones para estudiar al Jesús humano</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Kathleen_Swadling/follow_the_yellow_brick_road_2">
          <span class="pr-2">Sigue el camino de baldosas amarillas</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
