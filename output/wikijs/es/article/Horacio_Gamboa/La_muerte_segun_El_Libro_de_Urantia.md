    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Luz_y_Vida/Eugenesia_Un_tema_controvertido">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Eugenesia: un tema controvertido</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Luis_Coll/Solo_la_vida_interior_es_realmente_creativa">
          <span class="pr-2">Sólo la vida interior es realmente creativa</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
