---
title: "La Revelación entra en el siglo XXI"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/UF_News_Online/Welcome_Contact_Details_2008_06">
        ...
        <a href="/es/article/Mo_Siegel/Decisions_April_2008_Board_meeting">
          <span class="pr-2">Decisiones destacadas de la reunión de abril de la Junta en París</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
