---
título: "Australia: ¿un país pagano? Una réplica"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Ken_Glasziou/Commentary_On_Scientific_Statements_In_UB_3">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Comentario sobre las declaraciones científicas del Libro de Urantia, Parte III</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Tom_Reynolds/Who_Am_I">
