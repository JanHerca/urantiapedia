---
title: "XIX Encuentro de lectores – Ciudad Real, 2023"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Luz_y_Vida/XIX_Encuentro_Presentaciones">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Presentaciones del XIX Encuentro de Lectores de El libro de Urantia en España</span>
        </a>
        </td>
        <td>
...
Este ha sido el primer Encuentro de lectores españoles desde el inicio de la pandemia, y ha sido realmente un placer comprobar que existe un grupo de lectores cohesionado y comprometido en nuestro país, con ideas para seguir avanzando en la diseminación de las enseñanzas de _El libro de Urantia_. Ahora solo queda esperar el próximo, cuya lugar y fecha todavía están por determinar.
