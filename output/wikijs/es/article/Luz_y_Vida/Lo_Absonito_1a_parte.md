    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Jose_A_Rodriguez_Jorge/Camino_del_Paraiso_2">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Camino del Paraíso (poema)</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Luz_y_Vida/Noticias_de_la_Asociacion_Urantia_5">
