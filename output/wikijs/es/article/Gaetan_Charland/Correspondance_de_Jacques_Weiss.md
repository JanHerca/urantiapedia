    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Jean_Lapierre/Comment_nous_est_parvenue_LU">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">¿Cómo llegó hasta nosotros El Libro de Urantia?</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Maurice_Migneault/Noublions_pas_notre_propre_valeur">
          <span class="pr-2">No olvidemos nuestro propio valor</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
