...
## Introducción al cuarto período.
...
***Pregunta 1***: Lea las siguientes secciones: 1:3; 110:2; 110:2; 103:2;

En la primera cita de la introducción al último período, se trata de “espiritualizar la mente”.

**Describe con precisión este concepto y qué papel juega nuestra personalidad en él. ¿Cómo se puede vincular con el crecimiento del Supremo?**

***Pregunta 2***: En el segundo período estudiamos el plan de perfección progresiva que representa el aporte de las tres personas de la Trinidad. Además, nuestro Padre proporciona un programa educativo de espiritualización universal para los ascendentes del tiempo llamado «las Inevitabilidades».

**¿Cuál de estas inevitabilidades te atrae más y cuál has experimentado recientemente?**
...
***Pregunta 5***: Lea las siguientes secciones:

Además de los regalos que hemos recibido de nuestros Creadores, muchas otras influencias espirituales están trabajando en completa armonía con nuestro Ajustador del Pensamiento para ayudarnos en nuestra búsqueda de la perfección. Al final de su encarnación, Jesús derramó su Espíritu de Verdad sobre Urantia.

**¿Qué aporte a la espiritualización de nuestra mente nos aporta?**
