---
title: "Alguna información sobre la Fundación Urantia"
description: 
published: true
...
<figcaption>Encuentro de traductores en 1996 en Gonesse, cerca de París<br><em>De izquierda a derecha</em>: Andrei Reznikov (ruso), Nienke Grugman-Begemann (Holanda), Seppo Kanerva (Finlandia), Kwan Choi ( Fideicomisario — Corea del Sur), Michael Hanian (ruso), Guiseppe Zechinato (italiano), Marlène Michelson-Dupont, Georges Michelson-Dupont (Fideicomisario Francia), Richard Keeler (Fideicomisario — Estados Unidos), Jacques Dupont (Francia), Harald Kempf (alemán ), Patricia Mandelius-Sadler (fideicomisaria y presidenta de la Fundación Urantia - EE. UU.), Nicole Ruchti, Urs Ruchti (alemán), Peep Söber (Estonia), Joel Rehnström (Suecia), Seppo Niskanen (Finlandia), Natalia Shidlovskaya (Rusia), Vadim Knorre (Rusia), Jean Royer (Francia); <em>Agachados</em>: Tom Burns (Fideicomisario), Antonio Moya Serpa (español), Philip Rollnick (Fideicomisario)</figcaption>
</figure>

_Para Oriente Medio_, en árabe literario, hebreo.

_Para Asia_, coreano, indonesio, japonés.

**Para 2025** se completarán las traducciones al chino simplificado y tradicional, así como al iraní.

## CORREGIR LAS PRIMERAS TRADUCCIONES
...
## Una vez que las traducciones estén disponibles ¿QUÉ HACEMOS CON ELLAS?
...
## UNA VEZ CREADO EL PDF, ¿QUÉ HACEMOS CON ÉL?
...
## Presupuesto operativo anual medio de la Fundación Urantia
...
<figcaption>Ingresos totales por fuente<br>YTD hasta el segundo trimestre de 2019<br> <span style="color: transparent; text-shadow: 0 0 0 green;">&#9899;</span> Total: contribución real sin restricciones Ingresos<br> <span style="color: transparent; text-shadow: 0 0 0 red;">&#9899;</span> Total: ingresos por contribuciones restringidas<br> <span style="color: transparent; text -shadow: 0 0 0 skyblue;">&#9899;</span> Total: beneficio bruto de los libros<br> <span style="color: transparent text-shadow: 0 0 0 steelblue;">&#9899 ; </span> Total: otros ingresos (eventos, alquiler, regalías...</figcaption>
</figure>
...
<figcaption><span style="color: transparent; text-shadow: 0 0 0 lightgreen;">&#9899;</span> Total — Programa de desarrollo de libros <br> <span style="color: transparent; text- sombra: 0 0 0 azul claro;">&#9899;</span> Total — Programa de extensión <br> <span style="color: transparente texto-sombra: 0 0 0 violeta;">&#9899;</ span > Total: Programa de sitio web <br> <span style="color: transparent; text-shadow: 0 0 0 palevioletred;">&#9899;</span> Total: Programa educativo <br><span style="color" : transparent; text-shadow: 0 0 0 green;">&#9899;</span> Total — Programa de distribución de libros <br> <span style="color: transparent text-shadow: 0 0 0 steelblue;"> &#9899;</span> Total: Programa de creación <br> <span style="color: transparent; text-shadow: 0 0 0 purple;">&#9899;</span> Total: Programa de traducción <br> <span style="color: transparent; text-shadow: 0 0 0 red;">&#9899;</span> Total: programa de recaudación de fondos</figcaption>
</figure>

Programa de desarrollo de libros = _Programa de desarrollo de libros_

Programa de extensión = _programa social_

Programa de sitio web = _programa de desarrollo de sitio web_

Programa Educativo = _Programas educativos_

Programa de distribución de libros = _programa de distribución de libros_

Programa de construcción = _programa de mantenimiento del edificio de la Fundación_

Programa de traducción = _Programa de traducción_

Programa de recaudación de fondos = _Programa de recaudación de fondos._

Cabe señalar que la venta de los libros generó un margen bruto de $1907 \$$ debido principalmente a la versión electrónica del libro y sus traducciones, que tiene la ventaja de poder descargarse sin ningún otro costo. Las ventas de papel tienen en gran medida un déficit de más de $20000 \$$.

## ¿Cuántas vidas vende la Fundación?
