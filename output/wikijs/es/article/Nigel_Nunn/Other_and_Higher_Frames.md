---
title: "Otros y superiores marcos"
description: 
published: true
...
Para aquellos interesados en este tipo de cosas, ahora tenemos una serie de vídeos que nos guían a través de este aspecto de la quinta revelación de época, mostrando cómo _El Libro de Urantia_ extiende suavemente el mejor trabajo de la ciencia humana. Por ejemplo, explica por qué un mecanismo de tipo Higgs funciona tan bien, cómo los axiones ultimatónicos resuelven el problema de CP fuerte y la verdadera razón por la que el corrimiento al rojo es proporcional a la distancia. ¡Y eso es sólo el aperitivo!

Puede encontrar la serie completa de ‘Introducción al _El libro de Urantia_’ en el sitio web de ANZURA:

[https://anzura.urantia-association.org/2017/10/20/video-introduction-to-urantia-book/](https://anzura.urantia-association.org/2017/10/20/video-introduction-to-urantia-book/) – o
<br style="clear:both;"/>

Aquí hay enlaces a los videos (en YouTube), además de sus guiones (PDF):

**Parte 4A – Cimientos (v2)** https://youtu.be/ZerrvI4dLTQ

( [Guión de la Parte 4A](http://ubron.org/groupdocs/P4_A_Foundations1.pdf) )

**Parte 4B1 – Masa y Materia** https://youtu.be/-ZurF1V81W8

**Parte 4B2 – Masa y Materia** https://youtu.be/AE0uUliBfis

( [Guión de la Parte 4B](http://ubron.org/groupdocs/P4_B_Mass_Matter1.pdf) )

**Parte 4C – Explosión de Islas Oscuras (v2)** https://youtu.be/q8nAUKE0-OM

( [Guión para la Parte 4C](http://ubron.org/groupdocs/P4_C_2018_Apr15.pdf) )

Los dos enlaces siguientes son un borrador del guión del vídeo final (Parte 4D). Esta última parte sigue siendo un trabajo en progreso, mientras intento acomodar los desarrollos actuales en la cosmología convencional. ¡Se espera que la grabación de este vídeo final coincida con algunos avances sorprendentes en astronomía!

[Parte 4 D (i) Orvonton](http://ubron.org/groupdocs/P4D_Orvonton_Nov01.pdf)
[Parte 4 D (ii) Problemas](http://ubron.org/groupdocs/P4D_Issues_Nov01.pdf)

_**El Libro de Urantia**_: ¡un regalo para aquellas almas futuras que se atreverán a lanzarse más allá de donde pueden llegar la **razón** y la **sabiduría**!
