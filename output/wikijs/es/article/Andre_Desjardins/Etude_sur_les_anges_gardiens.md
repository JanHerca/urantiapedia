    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Samuel_Heine/Dieu_est_en_moi">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">dios esta en mi</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Claude_Flibotte/Precisions_sur_les_mots">
          <span class="pr-2">Detalles sobre palabras y sus definiciones.</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
