    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Steven_Hecht/Ruminations_on_Revelation">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Reflexiones sobre la revelación</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/article/Al_Lockett/When_Belief_Becomes_Faith">
          <span class="pr-2">Cuando la creencia se convierte en fe</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
