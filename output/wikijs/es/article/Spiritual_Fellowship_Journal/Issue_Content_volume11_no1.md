  ...
  <table>
    <tbody>
      <tr>
        ...
        <td>
        <a href="/es/article/Meredith_Sprunger/Transition_and_Transformation">
          <span class="pr-2">Transición y Transformación</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
