...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/article/Rev_Gregory_Young/Sermon_Sharing_Our_Spiritual_Experience">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Compartiendo nuestra experiencia espiritual</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Meredith_Sprunger/Significant_Books_Stealing_Jesus_by_Bruce_Bawer">
          <span class="pr-2">Libros importantes: El robo de Jesús</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
