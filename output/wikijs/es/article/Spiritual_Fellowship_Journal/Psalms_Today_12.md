    ...
    <tbody>
      <tr>
        ...
        <a href="/es/article/Rev_Gregory_Young/Sermon_There_is_Always_One_More_Move">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Siempre hay un movimiento más</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/article/Meredith_Sprunger/Significant_Books_Why_Christianity_by_John_Shelby_Spong">
          <span class="pr-2">Libros importantes: por qué el cristianismo debe cambiar o morir</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
