...
- :sound: Probar soluciones de texto a voz. El objetivo es ofrecer lectura automatizada de todos los libros del sitio web, empezando por _El Libro de Urantia_. En inglés existe un audio libro oficial de la Fundación Urantia. Para otros idiomas se van a buscar soluciones automatizadas.
- :sunrise_over_mountains: Crear un catálogo de imágenes para ilustrar _El libro de Urantia_, la _Biblia_ y el _Índice de Términos_. Actualmente está realizado con la parte IV del _Libro de Urantia_.
...
- Libros:
  - :green_book:Libros extrabíblicos: 11 libros previstos
  - :books: Otros libros que se supone que son fuentes: 17 libros planeados
- :page_with_curl: Artículos:
  ...
  - Otros: 100 previstos
  - TOTAL: 927 previstos
- :notebook: Ayudas al estudio: planeadas unas 20 de ellas.
- :memo: Esquemas: no planificados, sólo pruebas.
- :capital_abcd: Índices: actualmente se encuentran disponibles los índices para los términos. Se requiere planificar otros.

| Idioma     | Código | :green_book: Extrabíblicos  | :books: Libros fuentes  | :page_with_curl: Artículos | :notebook: Study aids | :memo: Diagrams   | :capital_abcd: Indexes |
| ---------- | :----: | :-------------------------: | :---------------------: | :------------------------: | :-------------------: | :---------------: | :--------------------: |
| Búlgaro    |  `bg`  |                             |                         |                            |                       |                   |                        |
| Checo      |  `cs`  |                             |                         |                            |                       |                   |                        |
| Danés      |  `da`  |                             |                         |                            |                       |                   |                        |
| Alemán     |  `de`  |                             |                         |                            |                       |                   |                        |
| Griego     |  `el`  |                             |                         |                            |                       |                   |                        |
| Inglés     |  `en`  | :heavy_check_mark:          | :clock2: 3 / 100+       | :clock2: 50 / 927          | :clock2:              |                   | :heavy_check_mark:     |
...
| :page_with_curl: | Artículos | Traducción automática de artículos: todos los idiomas excepto `en`.<br> Revisión de la traducción anterior: todos los idiomas excepto `en`. |
| :notebook: | Ayudas para el estudio | Planificar una lista de ayudas de estudio a incluir y crear una de pruebas. |
...
| Inglés     |  `en`  | :heavy_check_mark: | :heavy_check_mark: | :clock2:                  | :clock2:       | :heavy_check_mark: | :heavy_check_mark: | :clock2:        | :clock2:          | :clock2:   | :one:   |                          | :one:            | :one:       | :one:       |
...
| Francés    |  `fr`  | :heavy_check_mark: | :heavy_check_mark: | :clock2:                  |                | :heavy_check_mark: |                    |                 |                   |            |         |                          |                  |             |             |
