...
Tarea | Estado
--- | ---
Traducción del :ledger: _Paramony_ del inglés al idioma de destino. | :heavy_check_mark: (en 28 idiomas) \[[1](#note1)\]
Obtención de :blue_book: _El Libro de Urantia_ en el idioma de destino con el :ledger: _Paramony_ como notas al pie. | :heavy_check_mark: (en 28 idiomas)
Obtención de una traducción de :closed_book: _La Biblia_ en el idioma de destino con el :ledger: _Paramony_ como notas al pie. | :heavy_check_mark: (en 28 idiomas)
Subida de cambios mediante [Urantiapedia-backup](https://github.com/JanHerca/urantiapedia-backup) | :heavy_check_mark: (en 28 idiomas)


(<a id="note1">1</a>) Siempre que se indican 28 idiomas son estos: árabe, búlgaro, checo, danés, alemán, griego, inglés, español, estonio, persa, finlandés, francés, hebreo, croata, húngaro, indonesio, italiano, japonés, coreano, lituano, neerlandés, polaco, portugués, rumano, ruso, sueco, turco, chino.
...
Contenido | Status
--- | ---
:blue_book: _El Libro de Urantia_ con el :ledger: _Paramony_ | :heavy_check_mark: (en 28 idiomas) \[[1](#note1)\]
:closed_book: La _Biblia_ con el :ledger: _Paramony_ | :heavy_check_mark: (en 28 idiomas)
...
:sunrise_over_mountains: Imágenes (de momento solo en _El Libro de Urantia_) | :clock2: (en 28 idiomas)
...
(<a id="note1">1</a>) Siempre que se indican 28 idiomas son estos: àrabe, búlgaro, checo, danés, alemán, griego, inglés, español, estonio, persa, finlandés, francés, hebreo, croata, húngaro, indonesio, italiano, japonés, coreano, lituano, neerlandés, polaco, portugués, rumano, ruso, sueco, turco, chino.
