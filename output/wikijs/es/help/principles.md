...
<figure class="table">
  <table style="border-bottom:0.2em solid #c8ccd1;border-left:1px solid #c8ccd1;border-right:1px solid #c8ccd1;border-top:1px solid #c8ccd1;table-layout: fixed; width: 100%;">
    <tbody>
      <tr>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;"><a href="/es/help/start">Empezar con la Urantiapedia</a></td>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;text-align: center;"><a href="/es/help">Índice</a></td>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;text-align: right;"><a href="/es/help/content">Contenido de la Urantiapedia</a></td>
      </tr>
    </tbody>
  </table>
</figure>
...
* Crear un proyecto colectivo y colaborativo, no únicamente el trabajo de una sola persona de unas pocas trabajando de aisladamente.
...
* Voluntariado, hecho por personas inspiradas, no por el dinero: *Urantiapedia* no es un negocio, no va a tener publicidad o merchandising para recaudar fondos. Queremos personas inspiradas que quieran hacer un trabajo desinteresado y servir a la comunidad. En nuestra opinión, este tipo de personas son las que hacen el mejor trabajo. Si recodarmos la cita sobre la reserva de conocimiento del Paraíso, esta funciona gracias al servicio desinteresado de voluntarios.
