...
<figure class="table">
  <table style="border-bottom:0.2em solid #c8ccd1;border-left:1px solid #c8ccd1;border-right:1px solid #c8ccd1;border-top:1px solid #c8ccd1;table-layout: fixed; width: 100%;">
    <tbody>
      <tr>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;"><a href="/es/help/admin">Manual para Administradores</a></td>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;text-align: center;"><a href="/es/help">Índice</a></td>
        <td style="padding:0.4em 0.5em;border:1px solid #c8ccd1;width:33%;text-align: right;"><a href="/es/help/github_assistant">Manual para Editores Asistentes</a></td>
      </tr>
    </tbody>
  </table>
</figure>
...
- autorizados como «Editores Jefe» por un usuario «Administrador» de [Urantiapedia](https://urantiapedia.org).
- con buenos conocimientos de manejo de Git y GitHub.
