...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Zoroastrianism/Pahlavi_Texts_Part_3/Sad_Dar_Observations">
        ...
        <td>
        <a href="/es/book/Zoroastrianism/Pahlavi_Texts_Part_3/Sad_Dar_1">
...
1\. _En_ el nombre de Hôrmazd, el señor, el más grande _y_ sabio [^1], el que todo lo gobierna, el que todo lo sabe y el todopoderoso.

2\. Este es un libro (kitâb) sobre lo apropiado y lo inapropiado, extraído de la religión buena y pura [^2] de los adoradores del Ma<i>z</i><i>d</i>a. 3. Lo conveniente (vâ<i>g</i>ib) es que todos lo sepan y lo practiquen. 4. Y no es deseable que se independice ('<i>h</i>âlî) de esto ni por una sola hora (sâ'hat). 5. Porque, cuando uno se independiza, el pecado de cada uno puede abundar; y cuando se pone en práctica, la recompensa abunda.
