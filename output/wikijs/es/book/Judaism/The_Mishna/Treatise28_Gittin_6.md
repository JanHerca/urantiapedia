...
§ 7. Si un esposo dice a dos hombres: «Denle un Get a mi esposa», [^1043] o a tres: «Escriban un Get y dáselo a mi esposa», ellos deberán escribirlo <span id="p295"><sup><small>[ p. 295 ]</small></sup></span> y entregárselo. [^1044] Si a tres hombres les dice: «Denle un Get a mi esposa», estos pueden encargar a otros que lo escriban, porque los ha constituido como tribunal. Tal es el dictamen de R. Meir, y esta doctrina la trajo R. Hanina de Ono [^1045] de prisión; [^1046] dijo: «He recibido una tradición: cuando un esposo dice a tres hombres: «Denle un Get a mi esposa», ellos pueden encargar a otros que lo escriban, porque los ha constituido como tribunal». R. José dice: «Le decimos a este emisario que [^1047] también tenemos una tradición: cuando un esposo dice, incluso ante el Gran Tribunal de Jerusalén: «Denle un Get a mi esposa», estos están obligados a estudiar [las leyes del Get], [^1048] redactar un Get y entregárselo a la esposa». Cuando un esposo dice a diez hombres: «Escribid y entregad un Get a mi esposa», uno de ellos debe escribirlo y otros dos deben firmarlo; pero si dice: «Escribidlo todos», entonces uno debe escribirlo y todos deben firmarlo. Por lo tanto, si uno de ellos fallece, [^1049] el Get queda sin efecto.
...
[^1044]: 293:1 Es decir, puede revocar la comisión que otorgó. Nótese que, tanto en esta sección como en las siguientes, esta revocación solo es admisible antes de que el Get fuera entregado a la esposa.

[^1045]: 293:2 Esto se relaciona con un tiempo de persecución, cuando el Getsemaní fue destrozado tan pronto como se produjo el divorcio.

[^1046]: 294:3 Es decir, inmediatamente el mensajero la dejó para continuar con su misión.

[^1047]: 294:4 O que cayó debido a cualquier otra circunstancia accidental.

[^1048]: 294:5 Sin añadir que debían escribirlo.

[^1049]: 295:6 Y no se requiere otro escritor ni testigos.

[^1050]: 295:7 El nombre de un lugar.

[^1051]: 295:8 Dónde fue encarcelado R. Akivah y de quién aprendió la narración anterior.

[^1052]: 295:9 Es decir, R. Hanina de Ono, quien fue enviado a comunicar esta doctrina a los sabios.

[^1053]: 295:10 Si fuera necesario, o si no tuvieran práctica en la redacción de un Get. \[Véase el Comentario de Maimónides, _ad literam_.\]

[^1054]: 295:11 Antes de la entrega del Get.