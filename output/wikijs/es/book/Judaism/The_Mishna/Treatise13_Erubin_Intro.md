...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Judaism/The_Mishna/Treatise12_Sabbath_24">
...
El presente Tratado contiene regulaciones para la ‏ערובי חצרות‎, la unión de tribunales; también para la ‏ערוב תחומין‎, la unión de límites; y para la ‏ערוב מבוי‎, la unión de calles, también llamada ‏שתוף‎, cruce. [^179] La unión de tribunales trata de las reglas y regulaciones mediante cuya observancia las diversas casas que se encuentran en un tribunal, cada una de las cuales forma un reshuth privado distinto, [^180] se unen en un reshuth general. Esto se logra mediante la unión de todos los propietarios de los tribunales para obtener algún artículo alimenticio, que <span id="p71"><sup><small>[ p. 71 ]</small></sup></span> depósito en un lugar determinado; al hacer lo cual se considera, en derecho, que declaran y proclaman que todo el tribunal y todas las viviendas que allí se encuentran son una morada general y común para todos sus residentes; quienes de ese modo adquieren derecho a llevar y trasladar de una casa a otra, dentro de los límites del tribunal, en el día de descanso.
...
[^179]: 70:1 Hay otra mezcla llamada ‏ארוב טבשילין‎, combinación de cocina; para lo cual véase el Tratado Yom-tob.

[^180]: 70:2 Vide Introducción al Tratado del Sábado.

[^181]: 71:3 Vide Introducción al Tratado del Sábado.