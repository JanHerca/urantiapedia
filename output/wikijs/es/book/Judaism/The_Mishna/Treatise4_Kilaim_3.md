...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Judaism/The_Mishna/Treatise4_Kilaim_2">
        ...
        <td>
        <a href="/es/book/Judaism/The_Mishna/Treatise4_Kilaim_4">
...
§ 1. En un huerto de seis palmos cuadrados, se pueden sembrar cinco tipos diferentes de semillas: cuatro en las cuatro esquinas y la quinta en el centro. Si el huerto tiene un caballón, se pueden sembrar trece tipos diferentes: tres en cada esquina y uno en el centro; [^52] pero los grelos deben sembrarse en el caballón a medida que lo llenan. R. Jehudah dice: «Se pueden sembrar seis tipos diferentes en el centro del campo».
...
[^52]: 18:1 Es decir, un tipo en terreno llano, un tipo en la ladera de la montaña y un tipo en la cima.

[^53]: 20:2 El espacio necesario para cada hilera de calabazas es de cuatro codos de ancho; por lo tanto, habría una distancia de doce codos entre cada hilera de calabazas.