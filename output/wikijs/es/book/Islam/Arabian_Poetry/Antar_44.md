---
title: "Una carrera de caballos y sus consecuencias"
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Islam/Arabian_Poetry/Antar_43">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">El padre y el hermano de Abla nuevamente rescatados por Antar</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/book/Islam/Arabian_Poetry/Antar_45">
          <span class="pr-2">El matrimonio y la muerte del príncipe Malik</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
