---
title: "Abla y su familia rescatados por Antar"
    ...
    <tbody>
      <tr>
        ...
        <a href="/es/book/Islam/Arabian_Poetry/Antar_20">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Las pruebas de Abla durante la ausencia de Antar</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Islam/Arabian_Poetry/Antar_22">
          <span class="pr-2">La recepción del héroe por su tribu</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
