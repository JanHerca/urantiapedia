    ...
    <tbody>
      <tr>
        ...
        <a href="/es/book/Islam/Arabian_Poetry/Antar_1">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">El nacimiento y los primeros años del héroe</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/es/book/Islam/Arabian_Poetry/Antar_3">
          <span class="pr-2">Primeras hazañas bélicas</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
