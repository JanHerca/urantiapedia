---
title: "El dolor de Antar por la pérdida de Abla"
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Islam/Arabian_Poetry/Antar_22">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">La recepción del héroe por su tribu</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Islam/Arabian_Poetry/Antar_24">
          <span class="pr-2">Shiboob trae noticias de Abla</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
