    ...
    <tbody>
      <tr>
        ...
        <a href="/es/book/Halbert_Katzen/Eugenics_Race_and_The_Urantia_Book/9">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Capítulo 9. Formas del cráneo y tipos esqueléticos</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Halbert_Katzen/Eugenics_Race_and_The_Urantia_Book/11">
          <span class="pr-2">Capítulo 11. Diferencias entre las razas de color</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
