    ...
    <tbody>
      <tr>
        ...
        <a href="/es/book/Halbert_Katzen/Eugenics_Race_and_The_Urantia_Book/5">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Capítulo 5. Historia y destino</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Halbert_Katzen/Eugenics_Race_and_The_Urantia_Book/7">
          <span class="pr-2">Capítulo 7. Progreso cultural, sobrepoblación, y seres humanos subnormales</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
