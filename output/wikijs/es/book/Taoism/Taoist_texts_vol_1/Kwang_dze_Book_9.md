---
title: "Libro IX: Mâ Thî, o 'Los cascos de los caballos'"
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/es/book/Taoism/Taoist_texts_vol_1/Kwang_dze_Book_8">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Libro VIII: Phien Mâu, o 'Dedos palmeados'.</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Taoism/Taoist_texts_vol_1/Kwang_dze_Book_10">
          <span class="pr-2">Libro X: Khü Khieh, o 'Cortar y abrir carteras'</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
[^400]: 276:3 Un ser mítico, el primer domador de caballos. El nombre se le da a una estrella, donde se supone que ocupa su asiento como superintendente de los caballos celestiales. Se convirtió en la designación de Sun Yang, un famoso auriga de finales de la dinastía Kâu, pero no pudo ser a quien Kwang-dze tenía en mente.

[^401]: 276:4 Po-lâo dio el ejemplo del trato con los caballos tal como ahora se describe; pero el suplemento que he introducido parece resaltar mejor el significado de nuestro autor.

[^402]: 277:1 Compárese el mismo lenguaje en el Libro anterior, párrafo 3.

[^403]: 277:2 Pero el arte del tejedor o del agricultor no tiene más derecho a ser llamado primitivo que el del alfarero o el del carpintero.

[^404]: 277:3 Una expresión difícil; pero la traducción, probablemente, le da su verdadero significado. «Cielo» aquí es sinónimo de «el Tâo»; pero su uso muestra la facilidad con la que las mentes, incluso de Lâo y Kwang, recurrieron al término más antiguo con el que los padres chinos expresaron su reconocimiento de un Poder y Gobierno Supremo y Controlador.

[^405]: 279:1 Un antiguo soberano; pero no se puede decir nada más concreto sobre él. La mayoría de los críticos lo identifican con Shän-näng, el p. 280 Padre de la Agricultura, quien ocupa el lugar en las tablas cronológicas después de Fû-hsî, entre él y Hwang-Tî. En las Tablas de las Historias Dinásticas, publicadas en 817, se le coloca séptimo en la lista de quince reinados, que se ubican sin ninguna especificación de su duración entre Fû-hsî y Shän-näng. El nombre se escribe como ![](/image/book/Taoism/Taoist_texts_vol_1/28000.jpg) y ![](/image/book/Taoism/Taoist_texts_vol_1/28001.jpg).