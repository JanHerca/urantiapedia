    ...
    <tbody>
      <tr>
        ...
        <a href="/es/book/Benjamin_Willard_Robinson/The_Sayings_of_Jesus/15">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">XV. La fuerza de sus expresiones</span>
        </a>
        </td>
        <td>
        ...
        <a href="/es/book/Benjamin_Willard_Robinson/The_Sayings_of_Jesus/Reference_Library">
          <span class="pr-2">Biblioteca de referencia</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
