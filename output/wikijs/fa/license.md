...
این وب‌سایت تحت [مجوز Creative Commons Attribution-ShareAlike](https://creativecommons.org/licenses/by-sa/3.0/) در دسترس است، مگر اینکه اعلامیه حق نسخه‌برداری نشان داده شود، همانطور که در قسمت _محدودیت‌های_ این صفحه توضیح داده شده است.

شناسه کوتاه مجوز: **CC-BY-SA-3.0**
...
> این خلاصه ای از [مجوز کامل](/fa/help/full_license) قابل خواندن برای انسان است.
>
> شما آزاد هستید:
>
> - **به اشتراک گذاشتن**—برای کپی، توزیع و انتقال اثر، و
> - **به ریمیکس**—برای [تطبیق](https://en.wikipedia.org/wiki/Literary_adaptation) اثر
>
> برای هر هدفی، حتی تجاری.
>
> تحت شرایط زیر:
>
> - **اسناد**—شما باید اثر را به روشی که نویسنده یا مجوز دهنده تعیین کرده است (اما نه به نحوی که پیشنهاد می کند [خصیصه](https://en.wikipedia.org/wiki/Attribution_(copyright)) که آنها شما یا استفاده شما از کار را تایید می کنند.)
> - **به‌طور یکسان به اشتراک بگذارید**—اگر این اثر را تغییر دهید، تغییر دهید یا بر اساس آن بسازید، می‌توانید اثر حاصل را فقط تحت مجوز مشابه، مشابه یا سازگار توزیع کنید.
>
> با این درک که:
>
> - ** چشم پوشی **—هر یک از شرایط فوق در صورت دریافت مجوز از دارنده حق چاپ قابل چشم پوشی است.
> - **سایر حقوق**—به هیچ وجه هیچ یک از حقوق زیر تحت تأثیر مجوز قرار نمی گیرد:
> - حقوق شما [معامله منصفانه](https://en.wikipedia.org/wiki/Fair_dealing) یا [استفاده منصفانه](https://en.wikipedia.org/wiki/Fair_use)؛
> - [حقوق اخلاقی] نویسنده (https://en.wikipedia.org/wiki/Moral_rights)؛ و
> - حقوقی که افراد دیگر ممکن است در خود اثر یا نحوه استفاده از آن داشته باشند، مانند [علنی بودن](https://en.wikipedia.org/wiki/Personality_rights) یا [حریم خصوصی](https://en.wikipedia.org/wiki/Privacy_law).
> - **اطلاعیه**—برای هرگونه استفاده مجدد یا توزیع، باید شرایط مجوز این کار را برای دیگران روشن کنید. بهترین راه برای انجام این کار، پیوند به [https://creativecommons.org/licenses/by-sa/3.0/](https://creativecommons.org/licenses/by-sa/3.0/) است.
{.is-info}


### محدودیت های

برخی از مطالب در این وب سایت تحت اجازه دارندگان حق چاپ مختلف تکثیر می شوند یا در مالکیت عمومی هستند. مجوز کلی **CC-BY-SA-3.0** وب سایت در مورد این محتوا اعمال نمی شود.
...
- مقالات از [Innerface International](/fa/index/articles#innerface-international) (به همه زبان‌ها) حق نشر هر نویسنده و [The Urantia Book Fellowship](https://urantiabook.org/) است.
- حق چاپ مقالات [Urantian Journal](/fa/index/articles#urantian-journal) (به همه زبان‌ها) متعلق به هر نویسنده و [The Urantia Book Fellowship](https://urantiabook.org/) است.
- حق چاپ مقالات [Followship Journal](/fa/index/articles#fellowship-journal) (به همه زبان‌ها) متعلق به هر نویسنده و [The Urantia Book Fellowship](https://urantiabook.org/) است.
- مقالات از [Fellowship Herald](/fa/index/articles#fellowship-herald) (به همه زبان‌ها) حق چاپ متعلق به هر نویسنده و [The Urantia Book Fellowship](https://urantiabook.org/) است.
...
- مقالات از [Jan Herca](/fa/index/articles#articles-from-jan-herca) (در همه زبان‌ها) متعلق به [Jan Herca](https://buscandoajesus.wordpress.com) هستند و در زیر موجود هستند [مجوز Creative Commons Attribution-ShareAlike] (https://creativecommons.org/licenses/by-sa/3.0/).
...
- کتاب‌هایی که به‌عنوان  [منابع فرضی کتاب اورنشیا](/fa/book#books-supposed-to-be-sources) فهرست شده‌اند، همه به زبان انگلیسی و در دامنه عمومی هستند. ترجمه های ارائه شده تحت مجوز عمومی CC-BY-SA-3.0 سایت در دسترس هستند.
...
هیچ توافق یا تفاهمی بین شما و Urantiapedia در مورد استفاده یا تغییر این اطلاعات فراتر از مجوز Creative Commons Attribution-Sharealike 3.0 Unported (CC-BY-SA) وجود ندارد. در صورتی که کسی اطلاعاتی را که ممکن است در Urantiapedia یا هر یک از پروژه‌های مرتبط با آن پست کنید، تغییر، ویرایش، اصلاح یا حذف کند، هیچ‌کس در Urantiapedia مسئول نیست.
