...
- ساعت **اصلاحات یا اضافات به مطالبی که مجدداً استفاده می کنید**: هنگام اصلاح یا اضافه کردن متنی که از Urantiapedia به دست آورده اید، موافقت می کنید که محتوای اصلاح شده یا اضافه شده را تحت CC BY-SA 3.0 یا جدیدتر مجوز دهید.
