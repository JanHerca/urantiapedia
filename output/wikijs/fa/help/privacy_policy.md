...
از آنجا که همه (نه فقط وکلا) باید بتوانند به راحتی بفهمند که چگونه و چرا اطلاعات آنها جمع آوری و استفاده می شود، ما در سراسر این خط مشی به جای اصطلاحات رسمی تر از زبان رایج استفاده می کنیم. برای اطمینان از درک شما از برخی اصطلاحات کلیدی خاص، جدولی از ترجمه ها در اینجا آمده است:

وقتی می گوییم… | منظور ما: 
--- | --- 
"اورانتیا پدیا" / "ما" / "ما" / "ما" | رهبران تیم پروژه Urantiapedia.
"سایت اورانتیاپدیا" / "خدمات ما" | وب سایت و خدمات Urantiapedia (صرف نظر از زبان) پروژه Urantiapedia، از جمله [وب سایت اصلی Urantiapedia] (https://urantiapedia.org) (https://urantiapedia.org)، و نسخه های جایگزین در GitHub ([Urantiapedia Main) پروژه](https://github.com/JanHerca/urantiapedia) (https://github.com/JanHerca/urantiapedia) و [پروژه پشتیبان گیری Urantiapedia](https://github.com/JanHerca/urantiapedia-backup) ( https://github.com/JanHerca/urantiapedia-backup))، و همچنین رابط های برنامه نویسی برنامه (API)، ایمیل ها و اعلان ها؛ با این حال، به استثنای سایت‌ها و خدمات فهرست‌شده در بخش «این خط‌مشی رازداری چه چیزی را در زیر پوشش نمی‌دهد».
...
#### نمونه هایی از مواردی که این خط مشی رازداری پوشش 

می دهد برای شفافیت، این خط مشی رازداری بدون توجه به زبان آن را پوشش می دهد: 

- نسخه های جایگزین ما در GitHub، [پروژه اصلی Urantiapedia](https://github.com/JanHerca/urantiapedia ) (https://github.com/JanHerca/urantiapedia) و [پروژه پشتیبان گیری از Urantiapedia](https://github.com/JanHerca/urantiapedia-backup) (https://github.com/JanHerca/urantiapedia-backup) . 
...
- **سایر کاربران**. ما چندین ابزار ارائه می دهیم که به کاربران امکان می دهد با یکدیگر ارتباط برقرار کنند. ارتباطات ممکن است در زمانی که از سیستم‌های ما عبور می‌کنند تحت پوشش این خط‌مشی قرار گیرند، اما کاربرانی که این ارتباطات را دریافت می‌کنند و کارهایی که پس از دریافت آنها با ارتباطات انجام می‌دهند، مشمول این خط‌مشی نمی‌شوند. مثال‌ها عبارتند از: 
    - ارسال پیام در گروه‌های واتس‌اپ Urantiapedia؛ 
    - استفاده از [Trello](https://trello.com/) برای برنامه ریزی و مدیریت پروژه. 

##### اشخاص ثالث 

این خط مشی حفظ حریم خصوصی تنها روشی را که Urantiapedia جمع آوری، استفاده و افشای اطلاعات شخصی می کند پوشش می دهد و به اقدامات اشخاص ثالث نمی پردازد. برای مثال، این سیاست حفظ حریم خصوصی به اقدامات زیر نمی پردازد:
...
اگر رضایت دارید، می‌توانیم از GPS (و سایر فناوری‌هایی که معمولاً برای تعیین مکان استفاده می‌شود) استفاده کنیم تا محتوای مرتبط‌تری را به شما نشان دهیم. ما اطلاعات به‌دست‌آمده توسط این فناوری‌ها را محرمانه نگه می‌داریم، به جز مواردی که در این خط‌مشی ارائه شده است. 
...
### نحوه استفاده از اطلاعاتی که از شما دریافت می کنیم 
...
، در صورت موافقت، اطلاعات شخصی شما را برای هدف خاصی به اشتراک می گذاریم. 

#### به دلایل قانونی

در صورتی که به طور منطقی معتقد باشیم که برای اجرای یک حکم معتبر و قانونی لازم الاجرا، احضاریه، حکم دادگاه، قانون یا مقررات، یا سایر دستورات قضایی یا اداری لازم است، ما به اطلاعات شخصی شما دسترسی پیدا می کنیم، استفاده می کنیم، و/یا آن را فاش می کنیم. با این حال، اگر معتقدیم که درخواست خاصی برای افشای اطلاعات یک کاربر از نظر قانونی بی اعتبار است یا سوء استفاده از سیستم حقوقی است و کاربر آسیب دیده قصد مخالفت با افشای آن را ندارد، تمام تلاش خود را برای مبارزه با آن انجام خواهیم داد. ما متعهد هستیم که قبل از افشای اطلاعات شخصی شما در پاسخ به درخواست قانونی، حداقل ده (10) روز تقویمی، در صورت امکان، از طریق ایمیل به شما اطلاع دهیم. با این حال، ممکن است فقط در صورتی اخطار ارائه کنیم که از نظر قانونی از تماس با شما منع نشده باشیم، هیچ تهدید معتبری برای زندگی یا اندام وجود ندارد که با افشای درخواست ایجاد یا افزایش یابد.
...
، ما، یا کاربران خاصی با حقوق اداری خاصی که در زیر توضیح داده شده است، باید از اطلاعات شخصی شما استفاده کرده و آن را به اشتراک بگذاریم، در صورتی که به طور منطقی اعتقاد بر این است که برای اجرا یا بررسی موارد نقض احتمالی شرایط ما ضروری است. از این سیاست حفظ حریم خصوصی استفاده کنید. همچنین ممکن است برای بررسی و دفاع از خود در برابر تهدیدات یا اقدامات قانونی نیاز به دسترسی و به اشتراک گذاری اطلاعات شخصی داشته باشیم.

ما امیدواریم که این هرگز مطرح نشود، اما اگر فکر کنیم که به طور منطقی برای جلوگیری از آسیب جدی و جدی بدنی یا مرگ به یک فرد، یا برای محافظت از سازمان، کارکنان، پیمانکاران، کاربران یا مردم ما ضروری است، ممکن است اطلاعات شخصی شما را فاش کنیم. . ما همچنین ممکن است اطلاعات شخصی شما را فاش کنیم اگر به طور منطقی فکر کنیم که برای شناسایی، جلوگیری یا ارزیابی هرزنامه احتمالی، بدافزار، کلاهبرداری، سوء استفاده، فعالیت غیرقانونی و نگرانی های امنیتی یا فنی ضروری است. 

## محافظت 

### چگونه از اطلاعات شخصی شما محافظت می کنیم؟

ما در تلاش هستیم تا از اطلاعات شخصی شما در برابر دسترسی، استفاده یا افشای غیرمجاز محافظت کنیم. ما از انواع اقدامات فیزیکی و فنی، خط‌مشی‌ها و رویه‌ها (مانند رویه‌های کنترل دسترسی، فایروال‌های شبکه و امنیت فیزیکی) استفاده می‌کنیم که برای محافظت از سیستم‌ها و اطلاعات شخصی شما طراحی شده‌اند. متأسفانه، چیزی به نام انتقال یا ذخیره‌سازی اطلاعات کاملاً ایمن وجود ندارد، بنابراین نمی‌توانیم تضمین کنیم که امنیت ما (توسط اقدامات فنی یا از طریق نقض خط‌مشی‌ها و رویه‌های ما) نقض نمی‌شود.
...
اگر می‌خواهید درخواست دسترسی، به‌روزرسانی یا محدود کردن/مخالفت با پردازش اطلاعات شخصی، یا دریافت نسخه‌ای از اطلاعات شخصی خود را به منظور انتقال آن به سازمان دیگری داشته باشید، می‌توانید با ما تماس بگیرید. ما مطابق با قوانین قابل اجرا به درخواست شما پاسخ خواهیم داد. 
...
** برای محافظت از Urantiapedia و سایر کاربران، اگر با این سیاست حفظ حریم خصوصی موافق نیستید، نمی توانید از سایت Urantiapedia استفاده کنید.** 


### Urantiapedia کجاست و این برای من چه معنی دارد؟
...
از آنجایی که ما از همه کاربران مطابق با این سیاست حفظ حریم خصوصی محافظت می کنیم، رفتار خود را در پاسخ به سیگنال "ردیابی نکن" مرورگر وب تغییر نمی دهیم. 
...
**لطفاً توجه داشته باشید که در صورت وجود هر گونه تفاوت در معنا یا تفسیر بین نسخه انگلیسی اصلی این سیاست حفظ حریم خصوصی و ترجمه، نسخه اصلی انگلیسی اولویت دارد. ** 

--- 

بازگشت به صفحه با خلاصه در [مجوز، شرایط استفاده و سایر اطلاعات قانونی](/en/license).