...
"سایت اورانتیاپدیا" / "خدمات ما" | وب سایت و خدمات Urantiapedia (صرف نظر از زبان) پروژه Urantiapedia، از جمله وب سایت اصلی [Urantiapedia](https://urantiapedia.org)، و نسخه های جایگزین در GitHub ([Urantiapedia Main) پروژه](https://github.com/JanHerca/urantiapedia) و [پروژه پشتیبان گیری Urantiapedia](https://github.com/JanHerca/urantiapedia-backup))، و همچنین رابط های برنامه نویسی برنامه (API)، ایمیل ها و اعلان ها؛ با این حال، به استثنای سایت‌ها و خدمات فهرست‌شده در بخش «این خط‌مشی رازداری چه چیزی را در زیر پوشش نمی‌دهد».
...
- نسخه های جایگزین ما در GitHub، [پروژه اصلی Urantiapedia](https://github.com/JanHerca/urantiapedia) و [پروژه پشتیبان گیری از Urantiapedia](https://github.com/JanHerca/urantiapedia-backup). 
