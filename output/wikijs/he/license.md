...
אתר זה זמין תחת [רישיון Creative Commons Attribution-ShareAlike](https://creativecommons.org/licenses/by-sa/3.0/), אלא אם מוצגת הודעת זכויות יוצרים , כפי שהוסבר בחלק _הגבלות_ של דף זה. 

מזהה קצר של הרישיון: **CC-BY-SA-3.0** 
...
> זהו סיכום קריא אנושי של [הרישיון המלא](/he/help/full_license). 
> 
> אתה חופשי: 
> 
> - **לשתף**—להעתיק, להפיץ ולשדר את היצירה, ו- 
>- **לרמיקס**—ל[adapt](https://en.wikipedia.org/wiki/Literary_adaptation) העבודה 
>> 
לכל מטרה, אפילו מסחרית. 
> 
> בתנאים הבאים: 
> 
> - **שתף זהה**—אם תשנה, תשנה או תבנה יצירה זו, אתה רשאי להפיץ את היצירה המתקבלת רק תחת אותו רישיון, דומה או תואם. 
> 
> מתוך הבנה ש: 
>
> - **ויתור**—ניתן לוותר על כל אחד מהתנאים לעיל אם תקבל אישור מבעל זכויות היוצרים. 
> - **זכויות אחרות** - בשום אופן אף אחת מהזכויות הבאות אינן מושפעות מהרישיון: 
> - [העסקה הוגנת](https://en.wikipedia.org/wiki/Fair_dealing) או שלך [שימוש הוגן](https://en.wikipedia.org/wiki/Fair_use) זכויות; 
> - זכויות שיכולות להיות לאנשים אחרים ביצירה עצמה או באופן השימוש ביצירה, כגון [פרסום](https://en.wikipedia.org/wiki/Personality_rights) או  [פרטיות](https://en.wikipedia.org/wiki/Privacy_law).
> - **הודעה**—בכל שימוש חוזר או הפצה, עליך להבהיר לאחרים את תנאי הרישיון של עבודה זו. הדרך הטובה ביותר לעשות זאת היא באמצעות קישור אל [https://creativecommons.org/licenses/by-sa/3.0/](https://creativecommons.org/licenses/by-sa/3.0/) 
{.is -info} 


### הגבלות 

חלק מהתוכן באתר זה מופק באישור של בעלי זכויות יוצרים שונים, או שהוא ברשות הציבור. הרישיון הכללי **CC-BY-SA-3.0** של האתר אינו חל על תוכן זה. 
...
- מאמרים מ-[Innerface International](/he/index/articles#innerface-international) (בכל השפות) הם זכויות יוצרים של כל מחבר ושל [The Urantia Book Fellowship](https://urantiabook.org/). 
- מאמרים מ-[Urantian Journal](/he/index/articles#urantian-journal) (בכל השפות) הם זכויות יוצרים של כל מחבר ושל [The Urantia Book Fellowship](https://urantiabook.org/).
- מאמרים מ-[Fellowship Herald](/he/index/articles#fellowship-herald) (בכל השפות) הם זכויות יוצרים של כל מחבר ושל [The Urantia Book Fellowship](https://urantiabook.org/). 
...
- מאמרים מאת [Jan Herca](/he/index/articles#articles-from-jan-herca) (בכל השפות) הם זכויות יוצרים של [Jan Herca](https://buscandoajesus.wordpress.com) וזמינים תחת את [רישיון Creative Commons ייחוס-שיתוף זהה](https://creativecommons.org/licenses/by-sa/3.0/). 
...
- ספרים הרשומים כ[מקורות כביכול של ספר אורנטיה](/he/book#books-supposed-to-be-sources) הם הכל באנגלית וברשות הציבור. התרגומים המסופקים זמינים תחת הרישיון הכללי CC-BY-SA-3.0 של האתר. 
...
אין הסכם או הבנה בינך לבין Urantiapedia לגבי השימוש או השינוי שלך במידע זה מעבר לרישיון Creative Commons Attribution-Sharealike 3.0 Unported (CC-BY-SA); אף אחד ב-Urantiapedia אינו אחראי למישהו שישנה, ​​יערוך, ישנה או יסיר כל מידע שאתה עשוי לפרסם ב-Urantiapedia או בכל אחד מהפרויקטים הקשורים אליו.
