...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Chris_Ragetly/Le_suicide">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Suicide</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Max_Masotti/Quiz_maxien_11_Les_questions">
          <span class="pr-2">Quiz Maxien n°11 The questions</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
