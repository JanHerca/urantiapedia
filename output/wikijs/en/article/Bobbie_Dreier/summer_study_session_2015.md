---
title: "Summer Study Session 2015"
description: 
published: true
...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2015 Bobbie Drier<br>© 2015 International Urantia Association (IUA)</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Katrina_Glavan_Heise/lone_star_urantia_association_conference">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Lone Star Urantia Association Conference</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/IUA_Tidings/IUA_thank_you_to_outgoing_board_members_2015">
          <span class="pr-2">Private: Thank You to Outgoing Board Members</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
Although readers gather for a variety reasons, a major incentive for attending is the high quality of the workshops that are offered.  The conference team is requesting workshop proposals appropriate for new readers as well as in-depth study for “veterans.” There will be a track for workshops that are primarily experiential, but all workshop leaders should plan to engage participants actively.

If you have an idea for a workshop on this summer’s theme, please request a Workshop Proposal Form from David Kulieke, [david.kulieke@gmail.com](mailto:david.kulieke@gmail.com).
