    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/James_Woodward/focus_on_the_father_stop_resisting">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Focus on the Father – Stop Resisting</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/IUA_Tidings/IUA_2021_isb_news_2">
          <span class="pr-2">International Service Board News</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
