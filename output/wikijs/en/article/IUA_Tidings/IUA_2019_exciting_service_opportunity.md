    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Ed_Owen/joe_south_lake_tahoe">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Joe in South Lake Tahoe</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/IUA_Tidings/IUA_2019_language_multi_linguist_project">
          <span class="pr-2">Language Multi-Linguist Project</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
