---
title: "Study Groups: New Thoughts from an Old Reader"
description: 
published: true
...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2010 Mike Wood<br>© 2010 Urantia Foundation</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Jeff_Wattles/Appreciative_Inquiry_for_Study_Groups">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Appreciative Inquiry for Study Groups</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Aaron_Rutan/A_Follow_Up_to_Placing_Urantia_Books_in_Alternative_Libraries">
          <span class="pr-2">A Follow Up to Placing Urantia Books in Alternative Libraries</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
If you are not quite sure how to start a study group, call or email me.
