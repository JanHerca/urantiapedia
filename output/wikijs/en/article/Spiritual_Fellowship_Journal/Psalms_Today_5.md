    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Rev_Gregory_Young/Sermon_Taking_Responsibility_for_Our_Lives">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Sermon: Taking Responsibility for Our Lives</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Merlyn_Cox/Serving_God_Within_the_Church">
          <span class="pr-2">Serving God Within the Church</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
