    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Larry_Mullins/In_His_Presence">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">In His Presence</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Jay_Newbern/Go_Into_All_the_World_to_Every_Race_Tribe_and_Nation">
          <span class="pr-2">Go Into All the World, to Every Race, Tribe, and Nation</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
