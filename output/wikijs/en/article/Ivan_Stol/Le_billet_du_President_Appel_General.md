...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Le_Lien/066">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le Lien Urantien — Issue 66 — Spring 2014 — Contents</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Guy_de_Viron/Embouteillage">
          <span class="pr-2">Traffic jam</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
