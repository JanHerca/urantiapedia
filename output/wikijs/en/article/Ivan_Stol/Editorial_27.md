...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Le_Lien/098">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le Lien Urantien — Issue 98 — June 2022 — Contents</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Mamadou_Doudou_Diagne/Une_Quete_Spirituelle_Dieu_En_Question">
          <span class="pr-2">A Spiritual Quest: God in Question</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
Otherwise, 'Urantian Europe is trying to build itself, but we are only at the mobilization of the swirling energies from which the suns will appear.

I'm also trying to restart the national meetings, but my emails seem to get lost in a dense fog with no response, just a few echoes!!!...
