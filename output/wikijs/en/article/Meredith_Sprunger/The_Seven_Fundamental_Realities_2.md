    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Le_Lien/Scoop_artistique_Interpretation_libre_Adam_Eve">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Artistic Scoop Free Interpretation "Adam-Eve"</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Sam_Real_Brousseau/Je_nai_que_vous_mon_Pere">
          <span class="pr-2">I have only you my "Father"</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
