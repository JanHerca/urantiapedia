---
title: "Presentations from the XX Meeting of Readers of The Urantia Book in Spain"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/M_Jose_Sanchez/Editorial_Luz_y_Vida_2024_07">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Luz y Vida — July-August 2024 — Editorial</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Luz_y_Vida/XX_Encuentro">
          <span class="pr-2">20th Meeting of readers of The Urantia Book in Spain</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
1. What is ethics and what is moral?
2. Are new moral and ethical rules needed?
3. Where does morality come from, according to _The Urantia Book_?
4. What is the meaning of existing as believers?

From the initial definitions, both according to the dictionary and the book, José Manuel separates ethics (more related to the social aspect and standards of behavior) from morality (linked to the individual aspect, with personal duty). The changes experienced in the third millennium lead us to consider whether new ethical and moral rules are needed, which leads us to look in the pages of the book for the answers to these questions.
<br style="clear:both;"/>
...
It also addresses new gender identities and the very definition of that word, and then considers what the immediate future holds for us in terms of interpersonal relationships, in light of the teachings of _The Urantia Book_.
<br style="clear:both;"/>
