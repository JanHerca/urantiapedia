    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Santiago_Rodriguez/Convergencias_y_divergencias_tambien_de_valores">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Convergences and divergences also of values</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Luz_y_Vida/Noticias_de_la_Asociacion_Urantia_21">
