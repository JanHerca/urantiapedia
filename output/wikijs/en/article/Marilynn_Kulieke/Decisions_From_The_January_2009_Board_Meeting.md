---
title: "Noteworthy Decisions From The January 2009 Board Meeting"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Mo_Siegel/Kind_and_Generous_Souls">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Kind and Generous Souls</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Marta_Elders/A_Vision_of_the_Future">
          <span class="pr-2">A Vision of the Future</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
## 1. Executive Director and Staff Reports
...
## 10. Standardized Reference Text Ad-hoc Committee
...
- The Expanded Board will review the standardized reference text and the proposed referencing system. Feedback will be given to the committee by May 1, 2009.
- The Standardized Reference Text Committee will provide a final report to Urantia Foundation and Uversa Press by July 1, 2009.
- The Board will decide whether to adopt the recommendations of the committee at the July 2009 Board meeting.
