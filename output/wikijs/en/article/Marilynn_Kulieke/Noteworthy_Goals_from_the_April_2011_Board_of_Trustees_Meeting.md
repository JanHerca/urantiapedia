---
title: "Noteworthy Goals from the April 2011 Board of Trustees Meeting"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Mo_Siegel/Why_Study_Groups_Matter_to_the_Future_of_the_World">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Why Study Groups Matter to the Future of the World</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Jay_Peregrine/Jay_Peregrine_visits_Finland">
          <span class="pr-2">Jay Peregrine visits Finland</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
1. _Increase goodwill and communications with readers and reader groups worldwide via quarterly newsletters, local reader gatherings, and the fostering of organizational cooperation_.
...
2. _Increase accessibility and use of the facilities at 533 W Diversey Parkway in Chicago for activities directly related to furthering the Foundation's mission, which is to seed _The Urantia Book_ and its teachings throughout the world_.
...
The doors at 533 are open to Urantia Book organizations in need of meeting facilities to do work directly related to _The Urantia Book_. For further information please contact Tamara Strumfeld at tamara@urantia.org.

3. _Involve younger readers in the work of the Urantia Revelation._
...
1. _Increase book sales and distribution in 2011 by seven percent over the 20,000 books distributed in 2010._
...
2. _Increase distribution in North America, Brazil, Italy, Russia, Hungary, and Holland._
...
3. _Expand the audio version of _The Urantia Book_ into all existing translations._

A plan to make available audio versions for all translations is in progress.

## Translations:

1. _Advance the translations of_ The Urantia Book _and revisions now in progress._
...
2. _Finish developing and then implementing new software for translators._

The software, now in use, accommodates languages ranging from Balto-Slavic, Indo-European, and Altaic, to Sino-Tibetan. Fine-tuning continues as this tool becomes the standard for all translation and revision work. Special thanks to Rogerio da Silva for his enormous contributions in developing this software.
...
4. _Cooperate with other individuals and organizations whose goal is educating others about _The Urantia Book_ and its teachings._

This will include working with others in educational programs.

## Budgets and Donations:

1. _Stay within the approved 2011 operating budget which is less than the 2010 operating budget._
...
2. _Increase donations and the number of donors by 10\% from 2010._
...
1. _Develop the best possible, user-friendly internet download center at www.urantia.org._ 

This download center will offer readers the English edition of _The Urantia Book_ and all the translations formatted in accordance with the standard reference system.

2. _Finalize a book electronic data base that synchronizes, coordinates, and safeguards without redundancy - the processes necessary to create error free printed books, eBooks, online texts, translator tools, and all other forms of media._
...
In March, after months of preparation and consultation with experts, a group of computer specialists met in the home of Georges and Marlène Dupont to finalize a solution. The group recommended the software language L as the remedy. This may not sound like a big accomplishment, but it is one of the most important building blocks for the protection and dissemination of _The Urantia Book_ in the digital age. For the first time the digital book files are completely safeguarded, yet agile and progressive for the many purposes needed in the foreseeable future. Special thanks go to Larry Watkins for his work on the HTML files and to Rob Reno, Rogerio da Silva, Georges Michelson-Dupont, and Jay Peregrine for their tenacity in solving this looming problem.

## Organizational Development:

1. _Continue governance improvements._
