---
title: "Electrons-Neutrons-Protons"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Thierry_Lepage/Priere_sous_forme_de_Poeme">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Prayer in the Form of a Poem</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Le_Lien/La_Naissance_de_l_Esprit">
          <span class="pr-2">The Birth of the Spirit</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
1. An electronic charge based on X-rays is formed in the space of the atom. From this charge an electric field will be born.
2. The moving electric field will give rise to an electric current.
3. The electric current will produce a magnetic field.
