  ...
  <table>
    <tbody>
      <tr>
        ...
        <td>
        <a href="/en/article/Claude_Flibotte/Un_Voyage_Fantastique">
          <span class="pr-2">A Fantastic Journey</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
> “THE experience of dynamic religious living transforms the mediocre individual into a personality of idealistic power. Religion ministers to the progress of all through fostering the progress of each individual, and the progress of each is augmented through the achievement of all.” (<a id="a55_286"></a>[UB 100:0.1](/en/The_Urantia_Book/100#p0_1))
