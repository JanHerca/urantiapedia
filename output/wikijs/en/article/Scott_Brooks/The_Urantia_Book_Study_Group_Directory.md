...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2014 Scott Brooks<br>© 2014 Urantia Foundation</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Jean_Royer/Second_In_depth_Revision_of_the_French_Translation">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Second In-depth Revision of the French Translation</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Share_Beasley/Journal_of_a_Journey_Seeding_Urantia_Books_in_the_Caribbean">
          <span class="pr-2">Journal of a Journey: Seeding Urantia Books in the Caribbean</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
A most daunting challenge is that of keeping the database upto-date and ensuring that only active study groups are listed in the directory. To that end, a campaign began this spring to contact all study groups hosts and request that they validate their study group information.
...
- [This article](https://www.urantia.org/news/2014-07/urantia-book-study-group-directory)
