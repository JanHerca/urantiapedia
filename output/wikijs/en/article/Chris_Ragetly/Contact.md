...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Le_Lien/034">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le Lien Urantien — Issue 34 — Summer 2005 — Contents</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Jean_Claude_Romeuf/Explication_theorique_de_la_creation">
          <span class="pr-2">Theoretical Explanation of Creation</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
