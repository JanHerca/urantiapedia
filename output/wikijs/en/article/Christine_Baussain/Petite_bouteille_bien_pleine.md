...
1. Open the Book at the same time to
	...
	- b) study
		- each his own choice
		- all the same thing
2. Pray at the same time (even for a few minutes)
3. Establish a calendar of holidays (at least Birth, Baptism and Crucifixion)
4. Generalize the meal of remembrance
	- a) copy conforming to the original
	- b) free form
5. Find a “special convenient” location (see 1840-5)
