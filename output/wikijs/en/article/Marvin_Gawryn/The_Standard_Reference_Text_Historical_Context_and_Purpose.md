---
title: "The Standard Reference Text—Historical Context and Purpose"
description: 
published: true
...
<p class="v-card v-sheet theme--light gray lighten-3 px-2">© 2020 Marvin Gawryn<br>© 2020 Urantia Foundation</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/UF_News_Online/Infinite_Treasures_Are_Ours">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Infinite Treasures Are Ours</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Judy_Van_Cleave/Updates_from_the_October_2020_Trustee_Meeting">
          <span class="pr-2">Updates from the October 2020 Trustee Meeting</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
_SRT Committee Resolution Regarding Archaic Language_

The SRT Committee recommends adopting the following guidelines in considering possible instances of “archaic” language in the text of _The Urantia Book_:
...
2. When reviewing possible instances of archaic language in _The Urantia Book_, where no other issues exist related to our copyediting mandate, the SRT Committee's preference will be to retain the language in its original 1955 form. The committee will include such instances in its compilation of considered items, along with any clarifying commentary from its deliberations.

_Urantia Foundation remains dedicated to protecting and publishing the 1955 text free from errors. The SRT Committee will always be an integral part of this process, and we are grateful for their competence, oversight, commitment, and service to the revelation._

<figure id="Figure_2" class="image urantiapedia">
<img src="/image/article/UF_News_Online/2020_12/014.jpg">
</figure>

> All of the committee's reports and recommendations have been adopted by both publishers, thus establishing the pervasive standard text adopted by all major online publishers and used universally in translation projects.
{.is-info}
