...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Le_Lien/051">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le Lien Urantien — Issue 51 — Summer 2010 — Contents</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Le_Lien/Le_Bahaisme">
          <span class="pr-2">Bahaism</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
