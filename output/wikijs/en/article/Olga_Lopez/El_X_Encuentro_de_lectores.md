---
title: "The X Meeting of readers"
description: 
published: true
...
In the first part of the session, three of the six questions posed for each document had to be answered. Then, after about an hour and a half, we would all come together for the second part of the session, which would go through each of the questions. The person in each group who was in charge of taking notes was in charge of offering the answers that their group had given. I must say that all the questions were answered by the title “An ace up God's sleeve”, and that it was about the Shroud of Turin. In future issues of Light and Life we will develop an interesting debate that took place in the Internet Study Group on this subject.
...
Each of the attendees was given a list of six questions for each of the documents, related to direct quotes or references to the corresponding text. Each session was about three hours long and consisted of two parts: in the first, people got together in groups of three or four, with one of them acting as moderator/facilitator, and in which another person (or the same) took notes of what was answered in each question. The groups were changing members in each session, to give attendees the opportunity to group with different people. The only thing that remained constant were the moderators, around whom the groups were formed. The moderators were: Eduardo Altuzarra, Santiago Rodríguez, Andrés Pérez, Olga López, Carmelo Martínez and David Carrera. part of at least one group. And, curiously, some questions had “full”: all the groups answered it.
