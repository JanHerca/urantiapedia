    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Meredith_Sprunger/A_Call_to_Revival">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">A Call to Revival</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/William_M_Kelly/Thoughts_on_the_Brotherhood_of_Man">
          <span class="pr-2">Thoughts on the Brotherhood of Man</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
