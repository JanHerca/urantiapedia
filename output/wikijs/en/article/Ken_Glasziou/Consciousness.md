...
An experiment by Chiao et al.[^2] is illustrative. A polarizer was placed in one of two pathways to an interference detector so as to attach a label to any photon that proceeded along that pathway. Doing so immediately collapsed the interference phenomenon that heralded wave behavior.
...
The work that appears to have finally tilted the balance in favor of the bizarre findings of quantum physics and against the determinism of classical physics was done by Alaine Aspect[^6] whose experiments tested proposals of Irish physicist, John Bell.
...
There is another view of consciousness that includes what has been said in the previous paragraph but goes further. Given the name “monistic idealism,” it sees all consciousness as one, a universal consciousness that is the source, substance, and upholder of all that is[^4].
...
Is there any way that the idea of a universal consciousness can be demonstrated empirically? The abstract of a paper by Stuart Hameroff and Roger Penrose[^8] commences with:
...
What has been described above is not too far from what can be discerned in _The Urantia Book_ if we identify the ‘Universal Consciousness’ of quantum physics as being an aspect of the Infinite Spirit with similarities to cosmic mind.
