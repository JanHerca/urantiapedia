...
This paragraph verifies the fact that the revelators have provided a framework for their presentations. Additionally, the terms of the mandate [UB 101:4.1](/es/The_Urantia_Book/101#p4_1) explain the presence of error and out-datedness. But we are still left without any obvious explanation for the provision of certain prophetic material that does not appear to comply with the terms of the mandate as key or lost information. Why was it included?
