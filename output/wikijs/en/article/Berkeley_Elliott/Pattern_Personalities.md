...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 1977 Berkeley Elliott<br>© 1977 The Urantia Book Fellowship (formerly Urantia Brotherhood)</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Peter_and_Eileen_Laurence/Patterns_Of_Predictability">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Patterns Of Predictability</span>
        </a>
        </td>
        <td>
        <a href="/en/index/articles_the_urantian#april-1977-issue">
          <span class="mdi mdi-book-open-variant"></span><span class="pl-2">April 1977 Issue — Index</span>
        </a>
        </td>
        <td>
        <a href="/en/article/Patsy_and_Tucky_Hayes/Family_Patterns">
          <span class="pr-2">Family Patterns</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
