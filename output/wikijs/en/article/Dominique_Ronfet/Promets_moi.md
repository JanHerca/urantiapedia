    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Georges_Michelson_Dupont/Le_Progres_par_l_Education">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Progress Through Education</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/en/article/Claude_Flibotte/Une_Vision_Globale">
          <span class="pr-2">A Global Vision</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
