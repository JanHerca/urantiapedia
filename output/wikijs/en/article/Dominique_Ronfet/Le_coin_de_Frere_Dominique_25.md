---
title: "Little Corner of Brother Dom’ Enjoyment!"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/en/article/Max_Masotti/Quiz_maxien_19_Les_reponses">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Quiz Maxien n°19 The answers</span>
        </a>
        </td>
        <td>
...
It's like the wine in your glass.

It can be seen under various functions: thirst-quenching, for the joy it will bring you, for its calorie intake...but we cannot reduce it to just one of these aspects.

- So you have to drink it to know it?
- Indeed. So let's not wait any longer.
