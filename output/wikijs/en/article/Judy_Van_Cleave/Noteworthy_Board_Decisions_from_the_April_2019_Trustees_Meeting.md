---
title: "Noteworthy Board Decisions from the April 2019 Trustees Meeting"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/article/Marilynn_Kulieke/Creating_Translations_out_of_Love_Urantia_Foundations_Quality_Process">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Creating Translations out of Love: Urantia Foundation's Quality Process</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/article/Claire_Mylanus/Urantia_Foundations_Global_Cultural_Symposium">
          <span class="pr-2">Urantia Foundation's Global Cultural Symposium</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
In Q1 we sponsored two regional UAI conferences in
Estonia and Nigeria. We are also prepared to support the Fellowship's Pipeline of Light's efforts of placing Spanish Urantia Books in Latin America.
...
The 2018 Annual Report is available online. [Please click here to read it](https://www.urantia.org/sites/default/files/docs/annual_report_2018.pdf).
