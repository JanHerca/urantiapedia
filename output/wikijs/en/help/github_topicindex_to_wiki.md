---
title: Converting Encyclopedia from TXT to Wiki.js
description: 
published: true
...
The *Encyclopedia* files in TXT format are created and reviewed by *Editors-in-Chief*. These files should be left in folders like `input / txt / topic-index-xx` where `xx` is the code of the target language.

To convert these TXT files to Wiki.js format, follow these steps:
- Open *Urantiapedia Tools*.
- In *Process* select: Convert Encyclopedia (TXT) to Wiki.js.
