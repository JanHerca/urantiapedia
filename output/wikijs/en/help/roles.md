...
*Developers* have a GitHub account where they develop the functionality of *Urantiapedia Tools* and *Wiki.js*. Check [Developers help](/en/help/devs).
...
* The task will be to ensure the correctness of users and content. Reviewers will have permissions to block users or content that do not comply with policies and fair use of the web.
* A good knowledge of *The Urantia Book* will be needed in at least one language, but better if it is English and a second language on which the book is translated.
