...
* They have an account in this with editing permissions, and another in [GitHub](https://github.com/)
* The task will be to develop the functionalities of *Urantiapedia Tools* and *Wiki.js* necessary for the project. Modifications to Wiki.js are being centralized here: [Wiki.js](https://github.com/JanHerca/wiki), which is a *fork* of the original project.
* Good knowledge of HTML, CSS, Javascript, [Node.js](https://nodejs.org/), [Git](https://git-scm.com/), [GitHub](https://github.com/), [Bootstrap](https://getbootstrap.com/), and [Vue.js](https://vuejs.org/) is required.
...
- [Wiki.js - Customized project for Urantiapedia](https://github.com/JanHerca/wiki)
