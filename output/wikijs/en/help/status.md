...
- :sound: Test text-to-speech solutions. The goal is to offer automated reading of all the books on the website, starting with _The Urantia Book_. In English there is an official Urantia Foundation audio book. For other languages, automated solutions will be sought.
- :sunrise_over_mountains: Create a catalog of images to illustrate _The Urantia Book_, the _Bible_ and the _Topic Index_. It is currently done with part IV of _The Urantia Book_.
...
- Books:
  - :green_book: Extra-biblical books: 11 books planned
  - :books: Other books supposed to be sources: 17 books planned
...
| German     | `de` |                             |                       |                           |                       |                   |                        |
| Greek      | `el` |                             |                       |                           |                       |                   |                        |
| English    | `en` | :heavy_check_mark:          | :clock2: 3 / 100+     | :clock2: 50 / 927         | :clock2:              |                   | :heavy_check_mark:     |
| Spanish    | `es` | :clock2:                    | :clock2: 3 / 100+     | :clock2: 50 / 927         | :clock2:              |                   | :heavy_check_mark:     |
| Estonian   | `et` |                             |                       |                           |                       |                   |                        |
| Farsi      | `fa` |                             |                       |                           |                       |                   |                        |
| Finnish    | `fi` |                             |                       |                           |                       |                   |                        |
| French     | `fr` |                             |                       |                           |                       |                   |                        |
...
| English    | `en` | :heavy_check_mark: | :heavy_check_mark: | :clock2:                  | :clock2:       | :heavy_check_mark: | :heavy_check_mark: | :clock2:        | :clock2:          | :clock2:   | :one:   |                          | :one:            | :one:       | :one:       |
