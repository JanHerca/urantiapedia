...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/book/Islam/The_Philosophy_of_Alfarabi/Front_matter">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Front matter</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/book/Islam/The_Philosophy_of_Alfarabi/Life_and_Works">
          <span class="pr-2">Life and Works</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
