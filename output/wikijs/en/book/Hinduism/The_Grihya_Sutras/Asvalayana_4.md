...
5\. [^572]. Or without such a sacrifice.
...
5\. [^600]. If (the three fires) reach (the body) in the same moment, they say that this signifies the highest luck.

6\. [^601]. While (the body) is burning, he recites over it the same texts, ‘Go on, go on, on the ancient paths’ (Rig-veda X, 14, 7).
...
12\. [^604]. The younger ones first, the older ones last.
...
15\. [^605]. Let them subsist on bought or ready-made food.

16\. Let them eat no saline food for three nights.</span>
...
8\. [^625]. Having given to them double-folded Darbha blades, and a seat,

9\. [^626]. Having (again) given water (to them),
