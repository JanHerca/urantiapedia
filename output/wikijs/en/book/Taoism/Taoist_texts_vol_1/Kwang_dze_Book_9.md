---
title: "Book IX: Mâ Thî, or ‘Horses’s Hoofs'"
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/book/Taoism/Taoist_texts_vol_1/Kwang_dze_Book_8">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Book VIII: Phien Mâu, or ‘Webbed Toes.’</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/book/Taoism/Taoist_texts_vol_1/Kwang_dze_Book_10">
          <span class="pr-2">Book X: Khü Khieh, or ‘Cutting open Satchels.’</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
[^401]: 276:4 Po-lâo set the example of dealing with horses as now described; but the supplement which I have introduced seems to bring out better our author's meaning.

[^402]: 277:1 Compare the same language in the previous Book, par. 3.

[^403]: 277:2 But the weaver's or agriculturist's art has no more title to be called primitive than the potter's or carpenter's.
