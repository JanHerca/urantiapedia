...
<figcaption>Fig. 102. — Evolution of fina into legs. The upper figures show the theoretic change from fringe-fin (left) to foot of amphibian (right). Below: A and B, the skeleton of fish fins (crossopterygian) ; C, the skeleton of a foot of a Pennsylvanian amphibian. After Osborn.</figcaption>
</figure>
