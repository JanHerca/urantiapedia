...
**Classification**. — For our purposes, plants are most conveniently divided into (1) those which have no flowers but reproduce by spores and go through an alternation of generations (_Cryptogams_), as explained above; and (2) those which have flowers and reproduce directly from seeds (_Phanerogams_).
...
The _cones_ of Lepidophytes, while they looked much like those of modern evergreens or conifers, did not have seeds but were filled with spores (Pl., p. 377, Figs. 1, 4-6). The latter grew in large cases, which contained either minute spores, the microspores or fertilizing male parts (Pl., p. 377, Fig. 5), or large ones, the female macrospores (Pl., p. 377, Fig. 6), often forty times larger than the microspores. These two kinds of spores were developed either in different cones or in different parts of the same cone, and there were many more of the minute spores than of the larger ones.
