...
<figcaption>Fig. 65. — Restorations of the ventral side of two trilobites, to show the limbs, antennae, and cercopods. Somewhat enlarged. A, Crypiolithus tesselatus Green, with the antennae bent back (also see Fig. 13, p. 242) ; B, Xeolenus serratus (Rominger) , with the endopodites omitted on the right side, to show the exopodites better; note the two terminal cercopods. After Raymond.</figcaption>
</figure>
