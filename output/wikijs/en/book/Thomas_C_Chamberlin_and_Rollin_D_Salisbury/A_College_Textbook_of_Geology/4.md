...
the banks are sometimes angular, and sometimes crenate ([Fig. 131](#Figure_131)),
...
Some of the features just described are illustrated by [Fig. 118](#Figure_118). The even mountain crest in the background is the Kittatinny
...
The profiles of most valleys are curves, the curvature becoming less as the lower end of the stream is approached ([Fig. 151](#Figure_151)). It
...
the channels of streams in low water, and spread over their flood plains in high water, aggrading them and making them alluvial plains. Deposition in a valley which has no flat tends to develop one ([Fig. 152](#Figure_152)). Alluvial deposits on valley flats are usually but
...
Natural levees ([Fig. 153](#Figure_153)) are developed in flood plains aggraded by occasional floods. At such times the current in the main channel is swift; but as the water escapes its channel and spreads over
...
<figcaption>Fig. 156156. — string</figcaption>
</figure>
...
<img src="/image/book/Thomas_C_Chamberlin_and_Rollin_D_Salisbury/A_College_Textbook_of_Geology/string.jpg">
<figcaption>Fig. 158158A delta in a lake. The village is Silva Plana, in the Engadine, Switzerland. (Robin.) . — string</figcaption>
</figure>
...
Once started, the curves or meanders tend to become more and more pronounced ([Fig. 155](#Figure_155)). In the case represented by [Fig. 1](#Figure_1), PL VIII, the narrow neck of land between curves is almost
...
cut through. A later stage in the process is shown in [Fig. 2](#Figure_2), PL VIII.

When the stream has cut off a meander, the abandoned part of the channel often remains unfilled with sediment. If it contains standing water, as it often does, it becomes the site of a lake ([Fig. 156](#Figure_156)). Such lakes sometimes have the form of an ox-bow, and so are called ox-bow lakes (Pis. XIV and VIII).
...
Stream terraces1 are bench-like flats or narrow plains along the sides of valleys ([Fig. 163](#Figure_163)-4) and above their bottoms. They are usually narrow, but sometimes have great length in the direction of the axis of the valley.

The commoner river terraces are remnants of former floodplains, below which the streams which made them have cut their channels. They originate in various ways. (1) Some are due to inequalities of hardness ([Fig. 117](#Figure_117)). (2) If an alluvial flood
