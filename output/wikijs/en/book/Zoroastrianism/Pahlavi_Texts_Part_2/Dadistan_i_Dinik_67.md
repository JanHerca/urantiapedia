...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/en/book/Zoroastrianism/Pahlavi_Texts_Part_2/Dadistan_i_Dinik_66">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Chapter LXVI</span>
        </a>
        </td>
        <td>
        ...
        <a href="/en/book/Zoroastrianism/Pahlavi_Texts_Part_2/Dadistan_i_Dinik_68">
          <span class="pr-2">Chapter LXVIII</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
[^1]: (210:1) Reading dî<i>d</i>anŏîh; but the word can also be read sa<i>d</i>\-vanîh, which might stand for sa<i>d</i>\-gûnîh,‘ a hundred-coloured existence,’ a possible term for the rainbow, but the Persian dictionaries give no nearer term than sadkas, or sadkês.

[^2]: (210:2) M14 has ‘that mingling of many portions and few portions.’

[^3]: (210:3) Reading dî<i>d</i>anŏkŏ; but it can also be read sa<i>d</i>\-vanakŏ, a similar alternative to that in § 1.