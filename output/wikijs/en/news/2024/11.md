...
During the month of December we will continue this work by uploading translations of all the books of Islam into Spanish and French. There are works by readers of _The Urantia Book_ that draw parallels between it and the [_Quran_](/en/book/Islam/Quran), and we want to upload those works as well in a similar way as we have already done with the _Bible_. Finally, there are many other books that we have ready and waiting to be uploaded to Urantiapedia. This will be our focus in the coming months.

## :card_index: The Topical Index (The _Urantia Book_ Encyclopedia)

We are updating the _Urantiapedia Tools_ application in order to automate the creation of entries in this Encyclopedia as much as possible. One of the additions we are adding is the ability to edit the Encyclopedia in three parallel columns, in English, Spanish, and French, so that each topic is edited at the same time in all three languages. This will greatly reduce work time. 
