...
Ta witryna jest dostępna na licencji [Creative Commons Attribution-ShareAlike License](https://creativecommons.org/licenses/by-sa/3.0/), chyba że jest wyświetlana informacja o prawach autorskich , jak wyjaśniono w części _Ograniczenia_ tej strony. 

Krótki identyfikator licencji: **CC-BY-SA-3.0** 

<img src="https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-sa.png" alt="Creative Commons Attribution-ShareAlike License logo" width="200px" height="

#### Licencja Creative Commons 

> To jest czytelne dla człowieka podsumowanie [pełnej licencji](/pl/help/full_license). 
> 
> Możesz: 
> 
> - **Udostępniać** — kopiować, rozpowszechniać i przesyłać utwór oraz 
> - **Remiksować** — [adaptować](https://en.wikipedia.org/wiki/Literary_adaptation) utwór 
> 
> w jakimkolwiek celu, nawet komercyjnym. 
> 
> Pod następującymi warunkami: 
> 
> - **Udostępnij na tych samych warunkach**—Jeśli zmienisz, przekształcisz lub opracujesz na podstawie tego dzieła, możesz rozpowszechniać powstałe dzieło wyłącznie na tej samej, podobnej lub kompatybilnej licencji. 
> 
> Przy założeniu, że: 
>
> - **Zrzeczenie się** — Każdy z powyższych warunków może zostać zniesiony, jeśli uzyskasz pozwolenie od właściciela praw autorskich. 
> - **Inne prawa** — Licencja w żaden sposób nie wpływa na żadne z następujących praw: 
> - twoje [uczciwe postępowanie](https://en.wikipedia.org/wiki/Fair_dealing) lub [dozwolone korzystanie] (https://en.wikipedia.org/wiki/Fair_use) prawa; 
> - prawa, które inne osoby mogą mieć w odniesieniu do samego utworu lub sposobu jego wykorzystania, takie jak [reklama](https://en.wikipedia.org/wiki/Personality_rights) lub [prywatność](https://en.wikipedia.org/wiki/Privacy_law).
> - **Uwaga** — W przypadku ponownego wykorzystania lub rozpowszechniania należy wyjaśnić innym warunki licencji dotyczące tej pracy. Najlepszym sposobem na to jest link do [https://creativecommons.org/licenses/by-sa/3.0/](https://creativecommons.org/licenses/by-sa/3.0/) 
{.is -info} 


### Ograniczenia 

Niektóre treści na tej stronie zostały powielone za zgodą różnych właścicieli praw autorskich lub są własnością publiczną. Ogólna licencja **CC-BY-SA-3.0** witryny nie ma zastosowania do tych treści. 
...
- Artykuły z [Innerface International](/pl/index/articles#innerface-international) (we wszystkich językach) są chronione prawami autorskimi każdego autora i [The Urantia Book Fellowship](https://urantiabook.org/). 
- Artykuły z [Urantian Journal](/pl/index/articles#urantian-journal) (we wszystkich językach) są chronione prawami autorskimi każdego autora i [The Urantia Book Fellowship](https://urantiabook.org/).
- Artykuły z [Fellowship Herald](/pl/index/articles#fellowship-herald) (we wszystkich językach) są chronione prawami autorskimi każdego autora i [The Urantia Book Fellowship](https://urantiabook.org/). 
- Artykuły z [UB Annotated & UBTheNews](/pl/index/articles#ub-annotaded-ubthenews) (we wszystkich językach) są objęte prawami autorskimi [Halbert Katzen](https://ubannotated.com/). 
- Artykuły z [Jan Herca](/pl/index/articles#articles-from-jan-herca) (we wszystkich językach) są objęte prawami autorskimi [Jan Herca](https://buscandoajesus.wordpress.com) i są dostępne pod [Licencja Creative Commons Attribution-ShareAlike](https://creativecommons.org/licenses/by-sa/3.0/). 
...
– Księga Urantii (w języku angielskim) jest od 2006 roku w domenie publicznej 
. wszystko w języku angielskim iw domenie publicznej. Dostarczone tłumaczenia są udostępniane na podstawie ogólnej licencji CC-BY-SA-3.0 serwisu. 
...
> - **Pomoc w rozpowszechnianiu *Księgi Urantii** * objawienia na całym świecie. 
> - **Poprawa zrozumienia** nauk *Księgi Urantii*. 
> -**Połącz większość aktualnej wiedzy** dostępnej na temat objawienia Urantii. 
> 
> **Możesz**: 
> - **Czytać i drukować** nasze artykuły i inne media bezpłatnie. 
...
> 
> <small>Wyłączenie odpowiedzialności: To podsumowanie nie jest częścią Polityki prywatności i nie jest dokumentem prawnym. Jest to po prostu przydatne odniesienie do zrozumienia pełnej Polityki prywatności. Pomyśl o tym jako o przyjaznym dla użytkownika interfejsie do naszej Polityki prywatności.</small> 
> 
> **Ponieważ uważamy, że nie powinieneś podawać danych osobowych, aby uczestniczyć w swobodnym przepływie wiedzy, ale chcemy mieć pewność, że treści autorzy są osobami godnymi zaufania, możesz:** 
> - Czytać dowolne treści bez rejestracji konta. 
>
> 
> **Ponieważ chcemy zrozumieć, w jaki sposób używana jest Urantiapedia, aby móc ją ulepszyć dla Ciebie, zbieramy pewne informacje, gdy:** 
> - Dokonujesz publicznych datków. 
...
> - Przechowywanie twoich danych przez możliwie najkrótszy czas, który jest zgodny z utrzymaniem, zrozumieniem i ulepszaniem Urantiapedii oraz naszych zobowiązań wynikających z obowiązującego prawa. 
> 
> **Uwaga:** 
> - Wszelkie treści, które dodasz lub zmiany, które wprowadzisz na Urantiapedii, będą publicznie i na stałe dostępne. 
> - W ramach naszego zobowiązania do wykazania zaangażowania w projekt Urantiapedia, od czasu do czasu udostępniamy informacje publiczne oraz informacje zagregowane lub nieosobowe ogółowi społeczeństwa poprzez zrzuty danych i zbiory danych.
...
Nie ma porozumienia ani porozumienia między tobą a Urantiapedią w odniesieniu do twojego wykorzystania lub modyfikacji tych informacji poza licencją Creative Commons Attribution-Sharealike 3.0 Unported License (CC-BY-SA); nikt w Urantiapedii nie ponosi również odpowiedzialności za zmianę, edycję, modyfikację lub usunięcie jakichkolwiek informacji, które możesz zamieścić na Urantiapedii lub w jakimkolwiek z powiązanych z nią projektów.
