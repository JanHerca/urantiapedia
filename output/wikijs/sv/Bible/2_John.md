...
<svg xmlns="http://www.w3.org/2000/svg"
	...
	<g transform="translate(-7,-5)">
		...
		<text style="font-size:9px" x="61" y="60">2 Johannesbrevet</text>
	</g>
</svg>
</div>
...
Det andra Johannesbrevet är en bok i Nya testamentet som tillskrivs evangelisten Johannes, som traditionellt anses vara författaren till de andra två Johannesbreven och Johannesevangeliet (även om detta är omtvistat). De flesta moderna forskare tror att detta inte är aposteln Johannes, men i allmänhet finns det ingen konsensus om denna persons eller grupps identitet. 
