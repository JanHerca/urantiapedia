...
Parce que tout le monde (pas seulement les avocats) doit pouvoir comprendre facilement comment et pourquoi leurs informations sont collectées et utilisées, nous utilisons un langage commun au lieu de termes plus formels tout au long de cette politique. Pour vous aider à comprendre certains termes clés particuliers, voici un tableau des traductions :
...
Nous n'avons jamais besoin d'informations personnelles telles que le sexe, l'âge. 
