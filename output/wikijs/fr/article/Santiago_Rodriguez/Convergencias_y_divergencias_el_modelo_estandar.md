---
title: "Convergences et divergences : le modèle standard"
description: 
published: true
...
Même s’il est vrai qu’il existe des hypothèses et des théories qui l’envisageaient de cette façon. En 1974, [Jogesh Pati](https://es.wikipedia.org/wiki/Jogesh_Pati) et [Abdus Salam](https://es.wikipedia.org/wiki/Abdus_Salam) ont postulé la possibilité que les quarks et les leptons (je vous rappelle que ce sont les 12 particules qui composent la matière) étaient composés de « préons ». Ce modèle est actuellement freiné par l'impossibilité d'obtenir des résultats expérimentaux qui le soutiennent, en plus d'un nouveau revers : si le boson de Higgs se confirme, ce serait contraire aux prédictions du modèle préon.
