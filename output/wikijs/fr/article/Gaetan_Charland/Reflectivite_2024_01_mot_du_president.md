...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Reflectivite/2024_01">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Réflectivité — Número 375 — Janvier 2024 — Contenu</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Claude_Flibotte/Depart_dun_grand_homme">
          <span class="pr-2">Départ d'un grand homme</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
