    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Claude_Flibotte/Mon_experience_avec_lIA">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Mon expérience avec I'IA</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Francois_Audet/Reflexions_sur_notre_futur_morontiel">
          <span class="pr-2">Réflexions sur notre futur morontiel</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
