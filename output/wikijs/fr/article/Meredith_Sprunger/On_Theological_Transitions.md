    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Meredith_Sprunger/New_Dimensions_in_Theology">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Nouvelles dimensions de la théologie</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Merlyn_Cox/Arguing_With_Nicodemus">
          <span class="pr-2">Interface : Discuter avec Nicodème</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
