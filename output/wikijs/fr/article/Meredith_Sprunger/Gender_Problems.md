    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Meredith_Sprunger/On_Accepting_Evolutionary_Reality">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Sur l'acceptation de la réalité évolutive</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Merlyn_Cox/Defining_the_Terms_of_Equality">
          <span class="pr-2">Définir les termes de l'égalité</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
