    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Max_Masotti/Quiz_maxien_16_Les_questions">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Quiz Maxien n°16 Les questions</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Le_Lien/La_Puissance_de_l_Amour">
          <span class="pr-2">La Puissance de l'Amour</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
