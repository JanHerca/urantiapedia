...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2007 Association Urantia d'Espagne</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Luz_y_Vida/Cuantos_Sobreviven">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Combien survivent ?</span>
        </a>
        </td>
        <td>
