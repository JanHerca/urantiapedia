...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Le_Lien/004">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le Lien Urantien — Numéro 4 — Été 1997 — Contenu</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Luc_Lachance/Apres_la_mort">
          <span class="pr-2">Après la mort</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
