    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Mark_Kurtz/considerations_for_study_of_the_human_jesus">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Considérations pour l’étude du Jésus humain</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Kathleen_Swadling/follow_the_yellow_brick_road_2">
          <span class="pr-2">Suivez la route pavée de jaune</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
