---
title: "Quelques citations du Livre d'Urantia"
description: 
published: true
    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Merlyn_Cox/The_Geography_of_Faith">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">La géographie de la foi</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Merlyn_Cox/Significant_Books_Truth_in_Religion_By_Mortimer_Adler">
          <span class="pr-2">Livres importants : « La vérité dans la religion » par Mortimer Adler</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
