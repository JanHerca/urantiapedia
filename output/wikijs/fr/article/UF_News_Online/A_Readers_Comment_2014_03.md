---
title: "Comment le Livre d’Urantia m’a Trouvé et Ce Que Cela Signifie"
description: 
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Line_St_Pierre/What_the_Women_Are_Planning_a_Report_from_our_Second_Gathering">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Ce que les femmes planifient : un compte-rendu de notre deuxième réunion</span>
        </a>
        </td>
        <td>
