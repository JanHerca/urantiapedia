    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Meredith_Sprunger/A_Critical_Approach_to_UB">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Une approche critique du Livre d'Urantia</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Spiritual_Fellowship_Journal/Hymnody">
          <span class="pr-2">Hymnodie</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
