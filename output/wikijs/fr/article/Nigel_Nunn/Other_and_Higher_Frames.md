---
title: "Autres cadres et cadres supérieurs"
description: 
published: true
...
Pour ceux qui s’intéressent à ce genre de choses, nous avons maintenant une série de vidéos qui nous guident à travers cet aspect de la cinquième révélation d’époque, montrant comment _Le Livre d’Urantia_ prolonge doucement le meilleur travail de la science humaine. Par exemple, il explique pourquoi un mécanisme de type Higgs fonctionne si bien, comment les axions ultimatoniques résolvent le problème de CP fort, et la véritable raison pour laquelle le décalage vers le rouge est proportionnel à la distance. Et ce n’est que l’apéritif !

Vous trouverez toute la série « Introduction au Livre d’Urantia » sur le site Web d’ANZURA :

[https://anzura.urantia-association.org/2017/10/20/video-introduction-to-urantia-book/](https://anzura.urantia-association.org/2017/10/20/video-introduction-to-urantia-book/) – ou
<br style="clear:both;"/>

Voici les liens vers les vidéos (sur YouTube), ainsi que leurs scripts (PDF) :

**Partie 4A – Fondations (v2)** https://youtu.be/ZerrvI4dLTQ

( [Script pour la partie 4A](http://ubron.org/groupdocs/P4_A_Foundations1.pdf) )

**Partie 4B1 – Masse et matière** https://youtu.be/-ZurF1V81W8

**Partie 4B2 – Masse et matière** https://youtu.be/AE0uUliBfis

( [Script pour la partie 4B](http://ubron.org/groupdocs/P4_B_Mass_Matter1.pdf) )

**Partie 4C – Explosion des îles sombres (v2)** https://youtu.be/q8nAUKE0-OM

( [Script pour la partie 4C](http://ubron.org/groupdocs/P4_C_2018_Apr15.pdf) )

Les deux liens ci-dessous sont un projet de script pour la vidéo finale (Partie 4D). Cette dernière partie reste en cours de réalisation, car j'essaie de m'adapter aux développements actuels de la cosmologie dominante. L'enregistrement de cette vidéo finale devrait coïncider avec des développements surprenants en astronomie !

[Partie 4 D (i) Orvonton](http://ubron.org/groupdocs/P4D_Orvonton_Nov01.pdf)
[Partie 4 D (ii) Problèmes](http://ubron.org/groupdocs/P4D_Issues_Nov01.pdf)

_**Le Livre d'Urantia**_ – un cadeau pour les âmes futures qui oseront se lancer au-delà des limites de la **raison** et de la **sagesse** !
