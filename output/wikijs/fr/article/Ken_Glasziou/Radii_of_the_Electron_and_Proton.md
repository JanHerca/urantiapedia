...
> « Si la masse de la matière devait être agrandie jusqu'à ce que celle d'un électron soit égale à un dixième d'once, alors si la taille était proportionnellement agrandie, le volume d'un tel électron deviendrait aussi grand que la terre. » ([LU 42:6](/fr/The_Urantia_Book/42#p6))
...
> « Si le volume d'un proton – mille huit cents fois plus lourd qu'un électron – devait être agrandi jusqu'à la taille de la tête d'une épingle, alors, en comparaison, la tête d'une épingle atteindrait un diamètre égal à celui de l'orbite terrestre. autour du Soleil." ([LU 42:6](/fr/The_Urantia_Book/42#p6))
