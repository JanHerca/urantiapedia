---
title: "La science dans le Livre d'Urantia"
description: "Un mystère de prophétie inexplicable aggravé par une erreur inexplicable"
published: true
...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Ken_Glasziou/On_Divine_Truth">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Sur la Divine Vérité</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Ken_Glasziou/Geophysics_further_prophecies_Continental_Drift_and_Age_of_the_Solar_System">
          <span class="pr-2">Géophysique – autres prophéties : dérive des continents et âge du système solaire</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
<figcaption>Notre Soleil. La ligne blanchâtre dans l’encadré (à gauche) est la photosphère. La ligne extérieure est la chromosphère. La science moderne donne la température centrale à 15 millions de K (27 millions de F), la photosphère à 6 000 K (10 800 F) et la chromosphère (surface) à 10 000 K (18 000 F). Dans la couronne, la température atteint des millions de degrés K. <a href="https://www.nasa.gov/mission_pages/sunearth/science/Sunlayers.html">NASA</a> et <a href="https://apod.nasa.gov/apod/ap990923.html">NASA</a> </figcaption>
</figure>
...
En prenant le rayon de l'orbite terrestre autour du soleil comme 1,5 x 10^14^ mm et le rayon de la tête d'épingle comme 1 mm, le facteur de grossissement (k) est obtenu en divisant le rayon orbital de la Terre par le rayon de la tête d'épingle, donc 1,5 x 10^14^ / 1,0, soit 1,5 x 10^14^ (k)

Le rayon du proton multiplié par le facteur de grossissement (k) est égal au rayon de la tête d'épingle, d'où :

Rayon du proton x 1,5 x 10^14^ = rayon de la tête d'épingle (1,0 mm), donc

Rayon du proton = 1,0 /1,5 x 10^14^, soit 6,7 x 10^-15^ mm, ou 6,7 x 10^-18^m.

Le rayon classique du proton était donné comme étant de 0,85 x 10^-15^m, donc encore une fois la comparaison de l'Étude d'Urantia semblait absurde.
...
<figcaption>Une supernova, la nébuleuse du Crabe. <a href="https://www.nasa.gov/feature/goddard/2017/messier-1-the-crab-nebula">NASA</a> </figcaption>
</figure>
...
<figcaption>La plupart des neutrinos électroniques produits par le Soleil se transforment en d'autres types en route vers la Terre. © Johan Jarnestad/Académie royale des sciences de Suède </figcaption>
</figure>
...
[^1]: I Asimov, Le Neutrino (Dobson Books, Londres, 1966)

[^2]: EM et GR Burbidge, WA Fowler et F. Hoyle (1957)

[^3]: KS. Thorne, trous noirs et déformations temporelles : l'héritage scandaleux d'Einstein. (Picador, Londres. 1994)

[^4]: I Novikov, les trous noirs et l'univers. (Presse universitaire de Cambridge, 1990)