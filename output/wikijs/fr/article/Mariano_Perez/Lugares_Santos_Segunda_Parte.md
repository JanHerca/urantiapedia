---
title: "Lieux saints ? (Deuxième partie)"
description: 
published: true
...
<p class="v-card v-sheet theme--light gray lighten-3 px-2">© 2008 Mariano Pérez<br>© 2008 Association Urantia d'Espagne</p>
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Olga_Lopez/Luz_y_Vida_Num_12_Presentacion">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Luz y Vida — N° 12 — Présentation</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Luz_y_Vida/Que_se_espera_de_nosotros">
          <span class="pr-2">Qu'attend-on de nous ?</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
...
<figcaption><em>Rue Derekh Shekem en direction de la porte de Damas.<br>La zone du bâtiment située en arrière-plan à droite pourrait être l'emplacement du Golgotha. <br> Sur le mur de gauche se trouve une allée menant au tombeau du jardin</em></figcaption>
</figure>
...
<figcaption><em>Tombeau du jardin</em></figcaption>
</figure>
...
<figcaption><em>Chambre intérieure du tombeau avec deux niches ou plates-formes séparées l'une de l'autre par une plus large.</em></figcaption>
</figure>
...
<figcaption><em>Chapelle de l'Ascension</em></figcaption>
</figure>
...
<figcaption><em>Vue partielle du Mont des Oliviers, où a eu lieu la disparition du corps morontiel de Michel de Nébadon.</em></figcaption>
</figure>
