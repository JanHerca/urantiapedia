    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Steve_Dreier/Presidents_Report_to_the_General_Council">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Rapport du président au Conseil général</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Study_Group_Herald/Calendar_4">
          <span class="pr-2">Calendrier des événements</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
