...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 2013 Agustín Barajas<br>© 2013 Association Urantia d'Espagne</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Luis_Coll/Las_Verdades_Relativas">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Les vérités relatives</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Santiago_Rodriguez/Convergencias_y_divergencias_El_Entrelazamiento_Cuantico">
          <span class="pr-2">Convergences et divergences : Intrication quantique</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
