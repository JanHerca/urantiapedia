...
_Le Livre d'Urantia_, publié en 1955, fait une affirmation très précise au sujet de la Nova de Tycho concernant un problème sur lequel les astronomes n'avaient pas encore commencé à spéculer : ses origines. _Le Livre d'Urantia_ déclare dans une section intitulée _Nos associés étoilés_ :
...
> 
> La plus récente des éruptions cosmiques majeures à Orvonton [une partie de l'univers décrite dans _Le Livre d'Urantia_ qui est beaucoup plus grande que notre univers local et dans laquelle notre univers local est situé] fut l'extraordinaire explosion d'une double étoile, dont la lumière atteignit Urantia en 1572 après J.-C. Cette conflagration était si intense que l'explosion était clairement visible en plein jour.

_Le Livre d'Urantia_ met sa crédibilité en jeu avec l'affirmation selon laquelle la supernova a éclaté à partir d'une configuration d'étoiles doubles de soleils.
...
<img src="/image/article/Halbert_Katzen/Tychos_Nova/nova.jpg">
<figcaption>Image aux rayons X du SN 1572, le vestige de la Nova de Tycho</figcaption>
</figure>
...
_Le Livre d'Urantia_ avait plus d'une décennie d'avance sur la science lorsqu'il affirmait que la Nova de Tycho provenait d'une étoile double. Des recherches menées aussi récemment qu'en 2004 continuent de soutenir cette affirmation faite en 1955.
...
## Tycho's Nova Liens supplémentaires
...
- http://www.nrao.edu/imagegallery/php/level2a.php?class=Galactic_Sources\&subclass=Vestiges de supernovae
- http://adsabs.harvard.edu/cgi-bin/nph-basic_connect?qsearch=tycho\&version=1 (lien vers de nombreux rapports scientifiques sur Tycho)
- http://www.nature.com/nature/journal/v170/n4322/abs/170364a0.html (article de 1952, pas encore découvert en août 1952)
- [Lien](http://articles.adsabs.harvard.edu/cgi-bin/nph-iarticle_query?db_key=AST&bibcode=1945ApJ...102..309B&letter=.&classic=OUI&defaultprint=OUI\&whole_paper=OUI\&page=309\&epage=309&send=Envoyer+PDF&filetype=.pdf) (article de 1945)
- http://www.noao.edu/outreach/aop/observers/casstemp.html (redécouvert en 1952, Observatoire national d'astronomie optique)
- http://en.wikipedia.org/wiki/SN_1572
- http://en.wikipedia.org/wiki/Double_star
- http://www.astro.rug.nl/onderwys/ACTUEELONDERZOEK/JAAR2001/jakob/aozindex.html (explication de la supernova de type 1a)
...
- http://hubblesite.org/newscenter/archive/releases/2004/34/text/ (Annonce de la découverte d'une étoile compagne en 2004)
- http://books.google.com/books?id=1w5f5Po4XV8C\&pg=PA262\&lpg=PA262&dq=tycho+brahe+redécouvert+1952\&source=web\&ots=8Phwz7Wgs_&sig=OiNiaG2S1HcYovl8IC8Oc2dtSPA#PPR1,M1 (références historiques)
- http://adsabs.harvard.edu/abs/1984AZh...61.1125P (ne montre aucune classification binaire au début des années 80)
- http://astronomy.swin.edu.au/cosmos/S/Supernova+Classification (système de classification des supernovae 2)
...
[^1]: Les citations du _Livre d'Urantia_ sont fournies dans le format ci-dessus. Dans le cas présent, 41 se réfère au chapitre (appelé « Fascicule » dans _Le Livre d'Urantia_) ; 3 se réfère à la section ; et 3-5 se réfère aux paragraphes.
[^2]: http://en.wikipedia.org/wiki/Double_star
[^3]: http://en.wikipedia.org/wiki/Binary_star
[^4]: http://astronomy.swin.edu.au/cosmos/S/Supernova+Classement
