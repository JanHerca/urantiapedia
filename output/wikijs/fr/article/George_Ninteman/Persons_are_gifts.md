---
title: "Les personnes sont des cadeaux"
description: 
published: true
...
<p class="v-card v-sheet theme--light grey lighten-3 px-2">© 1983 George Ninteman<br>© 1983 The Urantia Book Fellowship (anciennement Urantia Brotherhood)</p>
    ...
    <tbody>
      <tr>
        ...
        <a href="/fr/article/Jeff_Wattles/The_role_of_reason_in_finding_the_Fathers_will">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Le rôle de la raison dans la recherche de la volonté du père</span>
        </a>
        </td>
        <td>
