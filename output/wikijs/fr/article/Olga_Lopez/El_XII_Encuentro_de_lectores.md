...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Olga_Lopez/Luz_y_Vida_Num_33_Presentacion">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Luz y Vida — N° 33 — Présentation</span>
        </a>
        </td>
        <td>
        ...
        <a href="/fr/article/Luz_y_Vida/Experiencias_en_la_diseminacion_del_libro">
          <span class="pr-2">Expériences de diffusion du Livre</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
