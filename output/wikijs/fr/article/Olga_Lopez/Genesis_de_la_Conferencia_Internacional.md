...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Olga_Lopez/Luz_y_Vida_Num_17_Presentacion">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Luz y Vida — N° 17 — Présentation</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Luz_y_Vida/Lo_mas_destacado_de_la_Conferencia_Internacional">
          <span class="pr-2">« Faits saillants de la conférence internationale »</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
