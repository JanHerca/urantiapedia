...
<figure class="table chapter-navigator">
  <table>
    <tbody>
      <tr>
        <td>
        <a href="/fr/article/Jean_Lapierre/Instruction_preliminaire_et_recommandations">
          <span class="mdi mdi-arrow-left-drop-circle"></span><span class="pl-2">Instruction préliminaires et recommandations</span>
        </a>
        </td>
        <td>
        ...
        <td>
        <a href="/fr/article/Claude_Flibotte/Les_esprits_mentaux_adjuvats_chez_les_animaux">
          <span class="pr-2">Les esprits-mentaux adjuvats chez les animaux</span><span class="mdi mdi-arrow-right-drop-circle"></span>
        </a>
        </td>
      </tr>
    </tbody>
