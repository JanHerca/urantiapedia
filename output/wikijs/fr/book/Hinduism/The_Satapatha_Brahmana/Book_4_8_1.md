...
<span id="v8_1_1_11"><sup><small>8:1:1:11.</small></sup></span> Il pose les Prânabhritah (retenues de souffle) [^34] : maintenant, le Prânabhritah étant – les airs vitaux <span id="p2"><sup><small>[ p. 2 ]</small></sup></span>, ce sont les airs vitaux qu'il confère ainsi à (Agni). Il les pose dans la première couche ; – ce qui est la première couche est la partie antérieure (partie fondamentale) d'Agni : c'est ainsi en avant qu'il met (dans Agni) les airs vitaux, d'où il y a (dans les créatures) ces (orifices des) airs vitaux en avant. <span id="p3"><sup><small>[ p. 3 ]</small></sup></span> 8:1:1:22\. Il les pose par dix et dix, car il y a dix airs vitaux ; et même si « dix-dix » peut signifier plusieurs fois, ici ils ne signifient que dix. Cinq fois il met dix (briques) à chaque fois ; car ce sont ces cinq (sortes d'animaux sacrificiels) qu'il accorde, et il y a dix airs vitaux dans chaque animal : sur tous il accorde ainsi les airs vitaux. Il pose (les briques) de manière à ne pas être séparé des animaux : il accorde ainsi des airs vitaux non séparés des animaux. Il les pose de tous côtés : de tous côtés il leur accorde ainsi (des orifices de) les airs vitaux.

<span id="v8_1_1_33"><sup><small>8:1:1:33.</small></sup></span> Et encore pourquoi il établit le Prâ<i>n</i>abh<i>ri</i>ta<i>h</i>. De Pra<i>g</i>âpati, une fois détendu (en produisant des créatures), les airs vitaux s'en allèrent. À eux, devenus des divinités, il dit : « Venez à moi, rendez-moi ce avec quoi vous êtes sortis de moi ! » — « Eh bien, crée cette nourriture que nous attendrons ici en regardant ! » — « Eh bien, créons tous les deux ! » — « Ainsi soit-il ! » — Ainsi les airs finaux et Pra<i>g</i>âpati créèrent cette nourriture, ces Prâ<i>n</i>abh<i>ri</i>t (briques).

<span id="v8_1_1_44"><sup><small>8:1:1:44.</small></sup></span> Devant (l'autel) il pose (dix briques [^35], — la première) avec (Vâ<i>g</i>. S. XIII, 54), 'Celui qui est devant, l'Existant,' — devant, sans aucun doute, est Agni ; et quant à la raison pour laquelle il parle de lui (comme étant) 'devant', c'est parce qu'ils éloignent le feu (du Gârhapatya) vers l'avant, et s'occupent d'Agni vers l'avant [^36]. Et quant à la raison pour laquelle il dit 'l'<span id="p4"><sup><small>[ p. 4 ]</small></sup></span> existant (bhuva),' Agni est en effet l'existant, car c'est par Agni que tout existe (bhû) ici. Agni, en effet, devenu le souffle, resta devant [^37] : c'est cette même forme [^38] qu'il confère maintenant (à Agni).

<span id="v8_1_1_55"><sup><small>8:1:1:55.</small></sup></span> \[Les autres avec\], 'Son fils, l'Existant, le Souffle' — de cette forme, le feu, il (Pra<i>g</i>âpati) façonna le souffle ; — 'Le Printemps, le fils du souffle' — de ce souffle il façonna le printemps [^39] ; — 'La Gâyatrî, la fille du Printemps' — de ce printemps il façonna le mètre Gâyatrî ; — 'De la Gâyatrî le Gâyatra' — de ce mètre Gâyatrî il façonna l'hymne Gâyatra [^40] ; — 'De la Gâyatra l'Upâ<i>m</i><i>s</i>u' — de la Gâyatra À partir de l'hymne, il a façonné l'Upâ<i>m</i><i>s</i>u-graha [^41] ; — <span id="p5"><sup><small>[ p. 5 ]</small></sup></span> 'De l'Upâ<i>m</i><i>s</i>u le Triv<i>ri</i>t', — à partir de l'Upâ<i>m</i><i>s</i>u-graha, il a façonné la forme de l'hymne à neuf versets ; — 'De l'Triv<i>ri</i>t le Rathantara', — à partir du Triv<i>ri</i>t-stoma, il a façonné le Rathantara-p<i>ri</i>sh<i>th</i>a [^42].

<span id="v8_1_1_66"><sup><small>8:1:1:66.</small></sup></span> 'Le <i>Ri</i>shi Vasish<i>th</i>a [^43]', - le <i>Ri</i>shi Vasish<i>th</i>a, sans aucun doute, est le souffle : dans la mesure où il est la chose principale, il est donc Vasish<i>th</i>a (le plus excellent) ; ou dans la mesure où il demeure (avec les êtres vivants) comme le meilleur résidant (vast<i>ri</i>), donc aussi il est Vasish<i>th</i>a. — « Par toi, pris par Pra<i>g</i>âpati », — c'est-à-dire, « par toi, créé par Pra<i>g</i>âpati », — « Je prends le souffle pour mes descendants (et mon peuple) ! » — avec cela il a introduit le souffle par l'avant. Séparément, il pose (ces dix briques) : quels désirs séparés il y a dans le souffle, ceux-là il les y dépose ainsi. Une seule fois il les a réglés [^44] : il en fait ainsi un seul souffle ; mais s'il les réglait chacun séparément, il couperait assurément le souffle en deux. Cette brique est triv<i>ri</i>t (triple) : la formule, le tassement et le sûdadohas [^45], c'est-à-dire triple, et triple est Agni, — aussi grand que <span id="p6"><sup><small>[ p. 6 ]</small></sup></span> est Agni, aussi grand que sa mesure, autant il dépose (sur l'autel) en mourant ainsi.

<span id="v8_1_1_77"><sup><small>8:1:1:77.</small></sup></span> Et sur le côté droit (sud) [^46] avec (Vâ<i>g</i>. S. XIII, 55), 'Celui à droite, le tout-ouvrier' — le tout-ouvrier (vi<i>s</i>vakarman), sans aucun doute, est ce Vâyu (le vent) qui souffle ici, car c'est lui qui fait tout ici ; et parce qu'il parle de lui comme (étant) 'à droite', c'est donc au sud qu'il souffle le plus. Vâyu, en effet, étant devenu l'esprit, est resté dans le côté droit (du corps) : c'est cette forme (partie) qu'il confère maintenant (à Agni).

<span id="v8_1_1_88"><sup><small>8:1:1:88.</small></sup></span> 'Son enfant, l'Esprit, le travailleur de tout' — de cette forme (toute ouvrière), le vent, il façonna l'esprit ; — 'l'été, le fils de l'esprit' — de l'esprit il façonna la saison estivale [^47] ; — 'la Trish<i>t</i>ubh, la fille de l'Été' — de la saison estivale il façonna le mètre Trish<i>t</i>ubh ; — 'du mètre Trish<i>t</i>ubh l'air Svâra' — du mètre Trish<i>t</i>ubh il créa l'air de l'hymne Svâra [^48] ; — 'de <span id="p7"><sup><small>[ p. 7 ]</small></sup></span> le Svâra l'Antaryâma, — à partir du Svâra-sâman il façonna l'Antaryâma-graha ; — à partir de l'Antaryâma le Pa<i>ñ</i><i>k</i>ada<i>s</i>a, — à partir de la coupe Antaryâma il façonna la forme d'hymne à quinze vers ; — à partir du Pa<i>ñ</i><i>k</i>ada<i>s</i>a le B<i>ri</i>hat, — à partir du Pa<i>ñ</i><i>k</i>ada<i>s</i>a-stoma il façonna le B<i>ri</i>hat-p<i>ri</i>sh<i>th</i>a.

<span id="v8_1_1_99"><sup><small>8:1:1:99.</small></sup></span> 'Le <i>Ri</i>shi Bharadvâ<i>g</i>a', le <i>Ri</i>shi Bharadvâ<i>g</i>a, est sans aucun doute l'esprit ; - 'vâ<i>g</i>a' signifie 'nourriture', et celui qui possède un esprit, possède (bharati) la nourriture, 'vâ<i>g</i>a ;' Ainsi, le Rishi Bharadvâgâ est l'esprit. — « Par toi, pris par Pragâpati », c'est-à-dire « par toi, créé par Pragâpati » ; — « Je prends l'esprit pour mes descendants ! » — ainsi il introduit l'esprit du côté droit. Séparément, il pose (ces dix briques) : quels que soient les désirs séparés qui existent dans l'esprit, il les y dépose ainsi. Une seule fois, il les a établis : il en fait ainsi un seul esprit ; mais s'il les établissait chacun séparément, il couperait assurément l'esprit en deux. Cette brique est triple : la signification de cela a été expliquée.
...
<span id="v8_1_2_11"><sup><small>8:1:2:11.</small></sup></span> Et à l'arrière (partie occidentale de l'autel), avec (Vâ<i>g</i>. S. XIII, 56), 'Celui-ci derrière, l'embrassant tout' ; — l'embrassant tout, sans aucun doute, est ce soleil-là, car dès qu'il [^49] se lève, tout cet espace embrassant prend existence. Et parce qu'il parle de lui comme (étant) 'derrière', on ne le voit donc que lorsqu'il va vers l'arrière (l'ouest). Le Soleil, en effet, étant devenu l'œil, est resté derrière : c'est cette forme qu'il confère maintenant (à Agni).

<span id="v8_1_2_22"><sup><small>8:1:2:22.</small></sup></span> 'Son enfant, l'Œil,' — de cette forme (qui embrasse tout), le Soleil, il façonna l'œil ; — 'les pluies, progéniture de l'œil,' — de l'œil il façonna la saison des pluies ; — 'la <i>G</i>agatî, la fille des pluies,' — de la saison des pluies il façonna le mètre <i>G</i>agatî ; — 'du <i>G</i>agatî le <i>Ri</i>ksama,' — du mètre <i>G</i>agatî il façonna l'hymne <i>Ri</i>ksama [^50] ; — 'du <i>Ri</i>ksama <span id="p9"><sup><small>[ p. 9 ]</small></sup></span> le <i>S</i>ukra,' — à partir du <i>Ri</i>ksama-sâman, il façonna le <i>S</i>ukra-graha ; — 'à partir du <i>S</i>ukra, le Saptada<i>s</i>a,' — à partir de la coupe du <i>S</i>ukra, il façonna la forme d'hymne à dix-sept versets ; — 'à partir du Saptada<i>s</i>a, le Vairûpa,' — à partir du Saptada<i>s</i>a-stoma, il façonna le Vairûpa-p<i>ri</i>sh<i>th</i>a.

<span id="v8_1_2_33"><sup><small>8:1:2:33.</small></sup></span> 'Le <i>Ri</i>shi <i>G</i>amadagni', le <i>Ri</i>shi <i>G</i>amadagni, sans aucun doute, est l'œil : dans la mesure où par lui le monde des vivants (<i>g</i>agat) voit et pense, donc le <i>Ri</i>shi <i>G</i>amadagni est l'œil. - 'Par toi, pris par Pra<i>g</i>âpati', c'est-à-dire 'par toi, créé par Pra<i>g</i>âpati', 'je prends l'œil pour mes descendants', ainsi il introduisit l'œil par derrière. Il pose séparément (ces dix briques) : les désirs distincts qui habitent l’œil, il les y place ainsi. Une seule fois, il les pose : il fait ainsi de cet œil un ; mais s’il les posait séparément, il le briserait assurément. C’est une brique triple : la signification de cela a été expliquée.

<span id="v8_1_2_44"><sup><small>8:1:2:44.</small></sup></span> Et sur le côté gauche (supérieur, nord), avec (Vâ<i>g</i>. S. XIII, 57), 'Ceci, sur le côté supérieur, le ciel' — dans la sphère supérieure, sans aucun doute, se trouvent les régions (quartiers) ; et quant à la raison pour laquelle il parle d'elles comme étant 'sur le côté supérieur (gauche)', les régions, en effet, <span id="p10"><sup><small>[ p. 10 ]</small></sup></span> sont au-dessus de tout ici. Et quant à la raison pour laquelle il dit, 'le ciel (ou la lumière),' les régions, en effet, sont le monde céleste (ou monde de lumière). Les régions, étant devenues l'oreille, sont restées au-dessus : c'est cette forme qu'il confère maintenant (à Agni).
...
<span id="v8_1_2_1010"><sup><small>8:1:2:1010.</small></sup></span> C'est donc cette même nourriture que les airs vitaux et Pra<i>g</i>âpati ont créée : tout aussi grand est en effet le sacrifice tout entier, et le sacrifice est la nourriture des dieux.
...
[^66]: 16:2 C'est-à-dire qu'il pose le cinquième ensemble autour de la Svayamât<i>ri</i><i>n</i><i>n</i>â (centrale), à ​​l'emplacement des deux briques Reta<i>h</i>si<i>k</i>. Cependant, p. 17, on ne sait pas très bien de quelle manière particulière ce cinquième ensemble de dix briques doit être disposé autour du centre de manière à se toucher. Les deux briques Reta<i>h</i>si<i>k</i>, occupant chacune un espace d'un pied carré au nord et au sud de la colonne vertébrale, sont séparées de la brique centrale (Svayamât<i>ri</i><i>n</i><i>n</i>â) par la brique Dviya<i>g</i>us d'un pied carré. Le côté intérieur de l'espace reta<i>h</i>si<i>k</i> serait donc à un pied et demi, et son côté extérieur à deux pieds et demi, distants du point central de l'autel. L'espace reta<i>h</i>si<i>k</i>, à proprement parler, consisterait donc en un rebord circulaire, obtenu en traçant deux cercles concentriques autour du centre, de diamètres respectifs de un pied et demi et de deux pieds et demi. Sur ce rebord (en tenant compte des angles des briques en saillie), il faudrait trouver de la place pour douze briques d'un pied carré, à savoir les deux reta<i>h</i>si<i>k</i>, déjà situés du côté est, au sud et au nord de l'épine dorsale, et dix prâ<i>n</i>abh<i>ri</i>ts. Français La façon dont ces derniers étaient disposés serait probablement la suivante : sur chacun des trois autres côtés, deux briques étaient posées de manière à se joindre l'une à l'autre en ligne avec la « colonne vertébrale » respective, de manière similaire aux deux briques reta<i>h</i>si<i>k</i> du côté est ; et les quatre briques restantes seraient ensuite placées dans les quatre coins - les douze briques formant ainsi, autant que possible, un rebord circulaire. Dans la construction de l'autel, cette portée reta<i>h</i>si<i>k</i> est déterminée par une corde tendue du centre à l'extrémité est de l'autel, après que les briques spéciales de la première couche ont été posées, des nœuds étant ensuite faits dans la corde au milieu de chacune des briques spéciales. La portée du reta<i>h</i>si<i>k</i> est donc déterminée, dans les couches suivantes, par un cercle tracé autour du centre, la partie du cordon étant marquée par le nœud central et le nœud reta<i>h</i>si<i>k</i> représentant le diamètre. Le schéma précédent montre la partie de la première couche contenant la rangée continue de briques spéciales posées en premier, à savoir : Svayamât<i>ri</i><i>n</i><i>n</i>â, Dviya<i>g</i>us, deux Reta<i>h</i>si<i>k</i>, Vi<i>s</i>va<i>g</i>yotis, deux Ritavyâ et Ashâ<i>dh</i>â ; et enfin l'ensemble central (ou cinquième) de dix prâ<i>n</i>abh<i>ri</i>ta<i>h</i>.placé autour de la brique centrale sur la portée du reta<i>h</i>si<i>k</i>.
  ![LA PARTIE CENTRALE DE LA PREMIÈRE COUCHE.](/image/book/Hinduism/The_Satapatha_Brahmana/01700.jpg)
