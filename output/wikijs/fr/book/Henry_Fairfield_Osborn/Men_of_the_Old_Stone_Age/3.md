...
<figcaption>Fig. 96. — Faune typique de la toundra. « Progressivement, les animaux de la toundra se sont déplacés vers le sud avec le climat froid qui, pour la première fois, a balayé toute l'Europe occidentale. » Le carcajou, <em>Gulo luscus borealis</em> ; le renne des plaines, (<em>Rangifer tarandus</em>) (dessiné d'après le type vivant) ; le renard arctique, <em>Canis lagopus</em> ; le bœuf musqué, <em>Ovibos moschatus</em> ; et le lemming rayé, (<em>Myodes torquatus</em>). Taille réelle : un vingt-cinquième. Le lemming (A) est également représenté à un septième de sa taille réelle. Dessin d'Erwin S. Christman.</figcaption>
</figure>
...
- L'hermine.
- Lagopède arctique.
- Belette d'Eversmann (_Belette des steppes_).
...
<figcaption>Fig. 125. — Répartition géographique des principales stations industrielles moustériennes d'Europe occidentale, attribuées à la race néandertalienne.</figcaption>
</figure>
