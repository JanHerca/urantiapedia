...
이 웹사이트는 저작권 고지가 표시되지 않는 한 [크리에이티브 커먼즈 저작자 표시-동일조건변경허락 라이선스 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.ko)에 따라 사용할 수 있습니다. , 이 페이지의 _Restrictions_ 부분에 설명되어 있습니다. 

라이선스의 짧은 식별자: **CC-BY-SA-4.0** 
...
이것은 [라이선스](/ko/help/full_license)에 대한 사람이 읽을 수 있는 요약(대체 아님)입니다.

<p style="text-align:center;"><b>이용자는 다음의 권리를 갖습니다:</b></p>
...
<p style="text-align:center;"><b>다음과 같은 조건을 따라야 합니다:</b></p>
...
<p style="text-align:center;"><b>주의:</b></p>
...
이 웹사이트의 일부 콘텐츠는 다른 저작권 소유자의 허가 하에 복제되거나 공개 도메인에 있습니다. 웹사이트의 일반 **CC-BY-SA-4.0** 라이선스는 이 콘텐츠에 적용되지 않습니다. 
...
- [Innerface International](/ko/index/articles_innerface)의 기사(모든 언어로 제공)는 각 저자와 [The Urantia Book Fellowship](https://urantiabook.org/)의 저작권입니다. 
- [Urantian Journal](/ko/index/articles_the_urantian)의 기사(모든 언어로 제공)는 각 저자와 [The Urantia Book Fellowship](https://urantiabook.org/)의 저작권입니다.
- [Fellowship Herald](/ko/index/articles_herald)의 기사(모든 언어로 제공)는 각 저자와 [The Urantia Book Fellowship](https://urantiabook.org/)의 저작권입니다. 
...
- [Jan Herca](/ko/index/articles#articles-from-jan-herca)의 기사(모든 언어로 제공)는 [Jan Herca](https://buscandoajesus.wordpress.com)의 저작권이며 다음에서 사용할 수 있습니다. [크리에이티브 커먼즈 저작자표시-동일조건변경허락 라이선스](https://creativecommons.org/licenses/by-sa/4.0/). 
...
- [유란시아 서의 추정 출처](/ko/book#books-supposed-to-be-sources)로 나열된 책은 모두 영어와 퍼블릭 도메인으로 제공됩니다. 제공된 번역은 사이트의 일반 CC-BY-SA-4.0 라이선스에 따라 사용할 수 있습니다. 
...
Creative Commons Attribution-Sharealike 4.0 Unported License(CC-BY-SA)를 넘어서는 이 정보의 사용 또는 수정에 대해 귀하와 Urantiapedia 사이에 합의나 이해가 없습니다. Urantiapedia의 어느 누구도 귀하가 Urantiapedia 또는 관련 프로젝트에 게시할 수 있는 정보를 변경, 편집, 수정 또는 제거할 책임이 없습니다.
