...
<svg xmlns="http://www.w3.org/2000/svg"
	...
	<g transform="translate(-7,-5)" style="display:inline">
		...
		<text style="font-size:9px;line-height:1.25;font-family: 'Merriweather', serif;text-align:center;text-anchor:middle;fill:#fff;stroke-width:0.2" x="61" y="60">베드로후서</text>
	</g>
</svg>
</div>
...
베드로 둘째 서신은 전통적으로 사도 베드로가 기록한 것으로 여겨지는 신약성경의 책입니다. 대부분의 비평적 성서 학자들은 서신을 가명으로 간주합니다(즉, 베드로가 아닌 다른 사람이 저술하여 베드로를 가명으로 사용함).

## Index

- [장 1](/ko/Bible/2_Peter/1)
- [장 2](/ko/Bible/2_Peter/2)
- [장 3](/ko/Bible/2_Peter/3)
