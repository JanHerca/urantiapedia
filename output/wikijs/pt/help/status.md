...
- :notebook: Auxílios de estudo: Planejei cerca de 20 deles.
...
| Alemão      |  `de`  |                            |                          |                          |                               |                  |                        |
| Grego       |  `el`  |                            |                          |                          |                               |                  |                        |
| Inglês      |  `en`  |     :heavy_check_mark:     |    :clock2: 3 / 100+     |    :clock2: 50 / 927     |           :clock2:            |                  |   :heavy_check_mark:   |
...
|     :page_with_curl:     | Artigos               | Tradução automática de artigos: todos os idiomas exceto `en`.<br> Revisão da tradução anterior: todos os idiomas exceto `en`.                                                                                                                                                                                                                                                                                                                                                                      |
|        :notebook:        | Auxílios de estudo    | Planeje uma lista de auxílios de estudo para incluir e crie uma para teste.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Francês     |  `fr`  | :heavy_check_mark: | :heavy_check_mark: | :clock2:                  |                | :heavy_check_mark: |                    |                 |                   |                      |         |                          |                  |             |             |
