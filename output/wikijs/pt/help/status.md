...
| :blue_book: _O Livro de Urântia_ | Adicionar novas traduções ou adicionar traduções existentes. Todas as novas traduções foram adicionadas, mas as existentes, como o francês e o coreano, estão em falta. |
