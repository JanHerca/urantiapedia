...
"Сайт Урантиапедии" / "наши услуги" | Веб-сайт и службы Урантиапедии (независимо от языка) проекта Урантиапедия, включая [основной веб-сайт Урантиапедии] (https://urantiapedia.org) (https://urantiapedia.org), а также альтернативные копии на GitHub ([Основной веб-сайт Урантиапедии проект](https://github.com/JanHerca/urantiapedia) (https://github.com/JanHerca/urantiapedia) и [проект резервного копирования Urantiapedia](https://github.com/JanHerca/urantiapedia-backup) ( https://github.com/JanHerca/urantiapedia-backup)), а также интерфейсы прикладного программирования (API), электронные письма и уведомления; за исключением, однако, сайтов и служб, перечисленных ниже в разделе «На что эта политика конфиденциальности не распространяется».
...
- Наши альтернативные копии в GitHub, [Основной проект Урантиапедии] (https://github.com/JanHerca/urantiapedia ) (https://github.com/JanHerca/urantiapedia) и [Проект Urantiapedia Backup](https://github.com/JanHerca/urantiapedia-backup) (https://github.com/JanHerca/urantiapedia-backup) . 
...
Вернуться на страницу с кратким описанием [Лицензия, Условия использования и другая юридическая информация](/en/license).