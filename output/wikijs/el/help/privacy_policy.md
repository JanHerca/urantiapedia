...
"Ιστότοπος Urantiapedia" / "οι υπηρεσίες μας" | Ιστότοπος και υπηρεσίες Urantiapedia (ανεξαρτήτως γλώσσας) του έργου Urantiapedia, συμπεριλαμβανομένου του [κεντρικού ιστότοπου Urantiapedia](https://urantiapedia.org) (https://urantiapedia.org) και των εναλλακτικών αντιγράφων στο GitHub ([Urantiapedia Main project](https://github.com/JanHerca/urantiapedia) (https://github.com/JanHerca/urantiapedia) και [Urantiapedia Backup project](https://github.com/JanHerca/urantiapedia-backup) ( https://github.com/JanHerca/urantiapedia-backup)), καθώς και διεπαφές προγραμματισμού εφαρμογών (API), μηνύματα ηλεκτρονικού ταχυδρομείου και ειδοποιήσεις. εξαιρουμένων, ωστόσο, των τοποθεσιών και των υπηρεσιών που αναφέρονται στην ενότητα "Τι δεν καλύπτει αυτή η Πολιτική Απορρήτου" παρακάτω.
...
«τρίτοι» / «τρίτοι» | Άτομα, οντότητες, ιστότοποι, υπηρεσίες, προϊόντα και εφαρμογές που δεν ελέγχονται, διαχειρίζονται ή διαχειρίζονται η Urantiapedia. Αυτό περιλαμβάνει άλλους χρήστες της Urantiapedia και ανεξάρτητους οργανισμούς ή ομάδες που βοηθούν στην προώθηση του κινήματος Urantiapedia, όπως οργανώσεις Urantia Book και ομάδες χρηστών, καθώς και εθελοντές, υπαλλήλους, διευθυντές, στελέχη, αποδέκτες επιχορηγήσεων και εργολάβους αυτών των οργανισμών ή ομάδων. 
...
#### Παραδείγματα του τι καλύπτει αυτή 

η Πολιτική Απορρήτου Για λόγους σαφήνειας, αυτή η Πολιτική Απορρήτου καλύπτει, ανεξαρτήτως γλώσσας: 

- Τα εναλλακτικά μας αντίγραφα στο GitHub, [Κύριο έργο της Urantiapedia](https://github.com/JanHerca/urantiapedia ) (https://github.com/JanHerca/urantiapedia) και [Urantiapedia Backup project](https://github.com/JanHerca/urantiapedia-backup) (https://github.com/JanHerca/urantiapedia-backup) . 
...
Αυτή η ενότητα αποτελεί μέρος της Πολιτικής Απορρήτου και προορίζεται να εξηγήσει λεπτομερώς ποιες καταστάσεις δεν καλύπτονται από την Πολιτική Απορρήτου μας. 

##### Μέλη κοινότητας 

- **Εθελοντές διοίκησης**. Πρόκειται για εθελοντές που επιβάλλουν τις πολιτικές του ιστότοπου Urantiapedia και διασφαλίζουν την ασφάλεια του ιστότοπου Urantiapedia. Όταν αυτοί οι διαχειριστές έχουν πρόσβαση σε Προσωπικές Πληροφορίες που δεν είναι δημόσιες, απαιτείται να συμμορφώνονται με την Πολιτική μας για την πρόσβαση σε μη δημόσιες πληροφορίες, καθώς και με άλλες πολιτικές που αφορούν συγκεκριμένα εργαλεία.
...
Αυτή η Πολιτική Απορρήτου καλύπτει μόνο τον τρόπο με τον οποίο η Urantiapedia συλλέγει, χρησιμοποιεί και αποκαλύπτει Προσωπικές Πληροφορίες και δεν αφορά τις πρακτικές τρίτων. Για παράδειγμα, αυτή η Πολιτική Απορρήτου δεν αφορά τις πρακτικές:
...
Επειδή προστατεύουμε όλους τους χρήστες σύμφωνα με την παρούσα Πολιτική Απορρήτου, δεν αλλάζουμε τη συμπεριφορά μας ως απάντηση στο σήμα "μην παρακολουθείτε" ενός προγράμματος περιήγησης ιστού. 
...
**Λάβετε υπόψη ότι σε περίπτωση οποιασδήποτε διαφοράς στο νόημα ή στην ερμηνεία μεταξύ της αρχικής αγγλικής έκδοσης αυτής της Πολιτικής Απορρήτου και μιας μετάφρασης, προηγείται η αρχική αγγλική έκδοση.** 

--- 

Επιστροφή στη σελίδα με περίληψη στο [Άδεια, Όροι χρήσης και άλλες νομικές πληροφορίες](/en/license).