...
- Τα εναλλακτικά μας αντίγραφα στο GitHub, [Κύριο έργο της Urantiapedia](https://github.com/JanHerca/urantiapedia) και [Urantiapedia Backup project](https://github.com/JanHerca/urantiapedia-backup). 
...
Επιστροφή στη σελίδα με περίληψη στο [Άδεια, Όροι χρήσης και άλλες νομικές πληροφορίες](/el/license).