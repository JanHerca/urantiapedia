...
Koska kaikkien (ei vain lakimiesten) pitäisi pystyä helposti ymmärtämään, miten ja miksi heidän tietojaan kerätään ja käytetään, käytämme tässä käytännössä yleistä kieltä muodollisempien termien sijaan. Tässä on käännöstaulukko, jotta ymmärrät tietyt keskeiset termit:
...
Tämä tietosuojakäytäntö kattaa vain tavan, jolla Urantiapedia kerää, käyttää ja paljastaa henkilötietoja, eikä se koske kolmansien osapuolien käytäntöjä. Tämä tietosuojakäytäntö ei koske esimerkiksi seuraavia käytäntöjä:
...
Jos annat suostumuksesi, voimme näyttää sinulle osuvampaa sisältöä GPS:n (ja muiden sijainnin määrittämiseen yleisesti käytettyjen tekniikoiden) avulla. Pidämme näiden teknologioiden avulla saamia tietoja luottamuksellisina, paitsi tässä käytännössä toisin. 

### Urantiapedia-sivuston käyttöön liittyvät tiedot
...
Me ja palveluntarjoajamme käytämme tietojasi lailliseen tarkoitukseen hyväntekeväisyystehtävämme toteuttamiseen, mukaan lukien: 
- Urantiapedia-sivuston käyttö, lahjoituksesi jakaminen ja palveluidemme hallinnointi. 
...
- Sähköpostien lähettäminen uutispäivityksillä ja viestinnällä tuotteista, joiden uskomme kiinnostavan sinua. 
    ...
    - Käyttääksesi julkisia lahjoituksiasi, joko yhdistettynä muiden julkisiin lahjoituksiin tai erikseen, luodaksesi sinulle uusia ominaisuuksia tai dataan liittyviä tuotteita tai saadaksesi lisätietoja Urantiapedia-sivuston käytöstä. 
...
Meidän tai tiettyjen käyttäjien, joilla on tietyt alla kuvatut järjestelmänvalvojan oikeudet, on käytettävä ja jaettava henkilötietojasi, jos sen uskotaan kohtuudella olevan tarpeen ehtojemme mahdollisten rikkomusten valvomiseksi tai tutkimiseksi. Käytä tai tätä tietosuojakäytäntöä. Saatamme myös joutua käyttämään ja jakamaan henkilötietoja tutkiaksemme ja puolustaaksemme itseämme oikeudellisilta uhilta tai toimilta.
...
Muista, että kun teet lahjoituksen Urantiapedia-sivustolle, sivuhistoria näyttää, milloin lahjoituksesi on tehty ja käyttäjätunnuksesi. Projektin panosten ja versiohistorian läpinäkyvyys on ratkaisevan tärkeää sen tehokkuuden ja luotettavuuden kannalta. 
...
Pyydämme sinua tutustumaan tietosuojakäytäntömme uusimpaan versioon. Urantiapedia-sivuston käytön jatkaminen tämän tietosuojakäytännön myöhemmän version voimaantulopäivän jälkeen merkitsee tämän tietosuojakäytännön hyväksymistä. 
