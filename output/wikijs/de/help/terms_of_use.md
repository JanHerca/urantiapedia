...
Wir bitten Sie, die Bedingungen unserer [Datenschutzrichtlinie](/en/help/privacy_policy) zu lesen, damit Sie wissen, wie wir Ihre Daten erfassen und verwenden. Da unsere Dienste von Menschen auf der ganzen Welt genutzt werden, können personenbezogene Daten, die wir sammeln, in unseren Einrichtungen gespeichert und verarbeitet werden. Durch die Nutzung unserer Dienste stimmen Sie einer solchen Übermittlung von Informationen außerhalb Ihres Landes zu. 

## 3. Inhalte, die wir hosten 

Unsere Inhalte dienen ausschließlich spirituellen Aufklärungszwecken: Wir hosten keinerlei Informationen, die sich auf berufliche Themen beziehen, einschließlich medizinischer, rechtlicher oder finanzieller Angelegenheiten. Kein Inhalt sollte als professionelle Beratung verstanden werden. 

## 4. Unterlassung bestimmter Aktivitäten


Bestimmte Aktivitäten, ob legal oder illegal, können anderen Benutzern schaden und gegen unsere Regeln verstoßen, und für einige Aktivitäten können Sie auch haftbar gemacht werden. Daher dürfen Sie sich zu Ihrem eigenen Schutz und dem anderer Benutzer nicht an solchen Aktivitäten auf unserer Website beteiligen. Zu diesen Aktivitäten gehören: 

- **Andere belästigen und missbrauchen** 
	- Kettenmails, Junk-Mails oder Spam an andere Benutzer senden. 
...
- **Beteiligung an falschen Aussagen, Nachahmung oder Betrug** 
	- Vorsätzliches oder wissentliches Posten von Inhalten, die eine Verleumdung oder Verleumdung darstellen; 
	- Versuch, sich als ein anderer Benutzer oder eine andere Person auszugeben, Ihre Zugehörigkeit zu einer natürlichen oder juristischen Person falsch darzustellen oder den Benutzernamen eines anderen Benutzers in Täuschungsabsicht zu verwenden; und 
...
- **Beteiligung an störendem und illegalem Missbrauch von Einrichtungen** 
	- Beteiligung an automatisierten Nutzungen der Website, die missbräuchlich oder störend für die Dienste sind und nicht von Urantiapedia genehmigt wurden; 
	- Unterbrechung der Dienste durch übermäßige Belastung der Website oder der mit der Website verbundenen Netzwerke oder Server;
	- Unterbrechung der Dienste durch Überschwemmung von Urantiapedia mit Mitteilungen oder anderem Datenverkehr, der keine ernsthafte Absicht erkennen lässt, die Website für den angegebenen Zweck zu nutzen; 
...
- **Bezahlte Beiträge ohne Offenlegung**
	- Anwendbares Recht, wie z. B. das Gesetz zur Behandlung von Interessenkonflikten, kann gezahlte Beiträge weiter einschränken oder eine detailliertere Offenlegung erfordern. 
...
- G. **Wiederverwendung**: Die Wiederverwendung von Inhalten, die wir hosten, ist willkommen, obwohl Ausnahmen für Inhalte bestehen, die im Rahmen von „Fair Use“ oder ähnlichen Ausnahmen nach dem Urheberrechtsgesetz beigetragen werden. Jede Wiederverwendung muss mit der/den zugrunde liegenden Lizenz(en) übereinstimmen. Wenn Sie eine von der Urantiapedia-Gemeinschaft entwickelte Textseite wiederverwenden oder weiterverbreiten, erklären Sie sich damit einverstanden, die Autoren auf eine der folgenden Weisen zu nennen: 
	...
	Bitte beachten Sie außerdem, dass Text, der aus externen Quellen stammt und in Urantiapedia importiert wurde, möglicherweise unter einer Lizenz steht, die zusätzliche Anforderungen an die Namensnennung stellt. Die Benutzer stimmen zu, diese zusätzlichen Zuordnungsanforderungen deutlich anzugeben. Solche Anforderungen können in den _Referenzen_ in der Kopf- oder Fußzeile einer Seite erscheinen und darauf hinweisen, dass einige oder alle Inhalte ursprünglich an anderer Stelle veröffentlicht wurden. Wo solche sichtbaren Vermerke vorhanden sind, sollten Weiterverwender sie aufbewahren.
...
- H. **Änderungen oder Ergänzungen an Material, das Sie wiederverwenden**: Wenn Sie Texte, die Sie von Urantiapedia erhalten haben, ändern oder hinzufügen, stimmen Sie zu, die geänderten oder hinzugefügten Inhalte unter CC BY-SA 3.0 oder höher zu lizenzieren.
...
- Die Nutzung des Dienstes durch die Mitwirkenden zu untersuchen, (a) um festzustellen, ob ein Verstoß gegen diese Nutzungsbedingungen oder andere geltende Gesetze oder Richtlinien vorliegt, oder (b) um geltendem Recht, Gerichtsverfahren oder entsprechenden behördlichen Aufforderungen nachzukommen; 
- Verbieten Sie einem Benutzer das Bearbeiten oder Beitragen oder blockieren Sie das Konto oder den Zugriff eines Benutzers für Handlungen, die gegen diese Nutzungsbedingungen verstoßen, einschließlich wiederholter Urheberrechtsverletzungen;
- rechtliche Schritte gegen Benutzer einleiten, die gegen diese Nutzungsbedingungen verstoßen (einschließlich Meldungen an die Strafverfolgungsbehörden); und 
- Urantiapedia anderweitig in einer Weise zu verwalten, die darauf abzielt, ihr ordnungsgemäßes Funktionieren zu erleichtern und die Rechte, das Eigentum und die Sicherheit von uns und unseren Benutzern, Lizenzgebern, Partnern und der Öffentlichkeit zu schützen. 
...
von Urantiapedia Der Vorstand von Urantiapedia kann von Zeit zu Zeit neue offizielle Richtlinien herausgeben. Sie verpflichten sich, diese gegebenenfalls einzuhalten. 
...
Sie stimmen zu, dass wir Ihnen Benachrichtigungen, einschließlich solcher zu Änderungen der Nutzungsbedingungen, per E-Mail, Post oder Postings auf der Projektwebsite zukommen lassen dürfen. 
