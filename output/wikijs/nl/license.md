...
Deze website is beschikbaar onder de [Creative Commons Attribution-ShareAlike License 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.nl), tenzij een copyrightvermelding wordt getoond , zoals uitgelegd in het gedeelte _Beperkingen_ van deze pagina. 

Korte identificatie van de licentie: **CC-BY-SA-4.0** 

<img src="https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-sa.png" alt="Creative Commons Naamsvermelding-GelijkDelen Licentielogo" width="200px" height="

#### Creative Commons Deed 

Dit is een voor mensen leesbare samenvatting van (en geen vervanging voor) de [licentie](/nl/help/full_license).

<p style="text-align:center;"><b>Je bent vrij om:</b></p>
...
<p style="text-align:center;"><b>Let op:</b></p>
...
Sommige inhoud van deze website is gereproduceerd met toestemming van verschillende auteursrechthouders, of bevindt zich in het publieke domein. De algemene **CC-BY-SA-4.0** licentie van de website is niet van toepassing op deze inhoud. 
...
- Artikelen van [Innerface International](/nl/index/articles_innerface) (in alle talen) vallen onder het copyright van elke auteur en van [The Urantia Book Fellowship](https://urantiabook.org/). 
- Artikelen uit [Urantian Journal](/nl/index/articles_the_urantian) (in alle talen) vallen onder het copyright van elke auteur en van [The Urantia Book Fellowship](https://urantiabook.org/).
- Artikelen uit [Fellowship Herald](/nl/index/articles_herald) (in alle talen) vallen onder het copyright van elke auteur en van [The Urantia Book Fellowship](https://urantiabook.org/). 
- Artikelen van [UB Annotated & UBTheNews](/nl/index/articles#ub-annotaded-ubthenews) (in alle talen) vallen onder het copyright van [Halbert Katzen](https://ubannotated.com/). 
- Artikelen van [Jan Herca](/nl/index/articles#articles-from-jan-herca) (in alle talen) zijn copyright van [Jan Herca](https://buscandoajesus.wordpress.com) en zijn beschikbaar onder de [Creative Commons Naamsvermelding-GelijkDelen-licentie](https://creativecommons.org/licenses/by-sa/4.0/). 
...
- Het Urantia Boek (in het Engels) is in het Publiek Domein vanaf 2006. 
- Boeken vermeld als [veronderstelde bronnen van Urantia Boek](/nl/book#books-supposed-to-be-sources) zijn allemaal in het Engels en in het publieke domein. De geleverde vertalingen worden beschikbaar gesteld onder de algemene CC-BY-SA-4.0-licentie van de site. 
...
**Een deel van onze missie is om:** 
- **Helpen bij de verspreiding van *Het Urantia Boek** * onthullingen over de hele wereld. 
- **Begrip verbeteren** van de leringen van *Het Urantia Boek*. 
-**Link de meeste van de huidige kennis** die beschikbaar is over de Urantia-openbaring. 
...
<small>Disclaimer: deze samenvatting maakt geen deel uit van het privacybeleid en is geen juridisch document. Het is gewoon een handig naslagwerk om het volledige privacybeleid te begrijpen. Zie het als de gebruiksvriendelijke interface naar ons privacybeleid.</small> 

**Omdat we vinden dat u geen persoonlijke informatie hoeft te verstrekken om deel te nemen aan de vrije kennisbeweging, maar we willen ervoor zorgen dat inhoud bijdragers betrouwbare mensen zijn, kunt u:** 
- Alle inhoud lezen zonder een account te registreren. 


**Omdat we willen begrijpen hoe Urantiapedia wordt gebruikt, zodat we het voor u kunnen verbeteren, verzamelen we enige informatie wanneer u:** 
- Publieke bijdragen levert. 
...
- Het gebruik van redelijke maatregelen om uw informatie veilig te houden. 
...
**Let op:** 
- Alle inhoud die u toevoegt of elke wijziging die u aanbrengt aan Urantiapedia zal publiekelijk en permanent beschikbaar zijn. 
