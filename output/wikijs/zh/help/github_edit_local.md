...
4. 转到 VS Code。
5. 按照前面的说明打开项目。
5. 在“源代码控制”面板中，转到“提交”子面板。点击小“获取”按钮，然后点击旁边的“拉取”按钮。此操作会同时获取并推送更改，以同步本地存储库。

![](/image/help/github_setting_9.png)

6. 有时，*Urantiapedia Tools* 代码的更改意味着依赖项的更改。您必须在 VS Code 的终端中运行“npm install”命令来安装或更新新的依赖项。这将更新项目的依赖项。
